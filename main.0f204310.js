...
class r{constructor(e,t,n){this.__parts=[],this.template=e,this.processor=t,this.options=n}update(e){let t=0;for(const n of this.__parts)void 0!==n&&n.setValue(e[t]),t++;for(const e of this.__parts)void 0!==e&&e.commit()}_clone(){const e=i.a?this.template.element.content.cloneNode(!0):document.importNode(this.template.element.content,!0),t=[],n=this.template.parts,r=document.createTreeWalker(e,133,null,!1);let o,a=0,c=0,l=r.nextNode();for(;a<n.length;)if(o=n[a],Object(s.d)(o)){for(;c<o.index;)c++,"TEMPLATE"===l.nodeName&&(t.push(l),r.currentNode=l.content),null===(l=r.nextNode())&&(r.currentNode=t.pop(),l=r.nextNode());if("node"===o.type){const e=this.processor.handleTextExpression(this.options);e.insertAfterNode(l.previousSibling),this.__parts.push(e)}else this.__parts.push(...this.processor.handleAttributeExpressions(l,o.name,o.strings,this.options));a++}else this.__parts.push(void 0),a++;return i.a&&(document.adoptNode(e),customElements.upgrade(e)),e}}},function(e,t,n){"use strict";n.r(t),n.d(t,"ElaraApp",(function(){return T}));var i=n(0);function s(e){return{effect:{opacity:[.5,1],transform:["scale(.95)","scale(1)"]},options:{duration:e}}}function r(e,t){return{effect:{opacity:t?[0,1]:[1,0]},options:{duration:e}}}var o=function(e,t,n,i){return new(n||(n=Promise))((function(s,r){function o(e){try{c(i.next(e))}catch(e){r(e)}}function a(e){try{c(i.throw(e))}catch(e){r(e)}}function c(e){var t;e.done?s(e.value):(t=e.value,t instanceof n?t:new n((function(e){e(t)}))).then(o,a)}c((i=i.apply(e,t||[])).next())}))};const a={Bootstrap:{promise:(e,t)=>{const n=[];for(const i of e){const e=new Promise(e=>{const n=t.querySelector(i),s=new MutationObserver(t=>{t.length&&"attributes"==t[0].type&&"loaded"===t[0].attributeName&&(s.disconnect(),e())});s.observe(n,{attributes:!0})});n.push(e)}return Promise.all(n)},load:(e,t,n,i)=>o(void 0,void 0,void 0,(function*(){const r="%s | Léonard C.",o=customElements.get("ui-"+e);t.classList.remove("full-width");const c=customElements.get("ui-not-found"),l=o?new o:new c(e);if(l.head&&l.head.title?document.title=r.replace("%s",l.head.title):document.title="Léonard C.",!0!==l.isFullWidth||t.classList.contains("full-width")?l.isFullWidth||t.classList.remove("full-width"):t.classList.add("full-width"),t.appendChild(l),l instanceof c)throw new a.Errors.NotFound(e);window.scrollTo(0,0),n.shown&&null===i&&(yield a.UI.elara().menu(!0));const d=window.requestAnimationFrame(()=>{const e=l.querySelector("div");if(!e)return void cancelAnimationFrame(d);const t=s(300);e.animate(t.effect,t.options)})}))},Constants:{modes:{default:"day"}},Routing:{redirect:(e,t="_blank")=>!!window.open(e,t),navigate:e=>(location.hash="#!"+e,!0),hashChange(e){const t=e.newURL.replace(location.origin+location.pathname,"").split("#!").filter(Boolean);let n=null;n=0===t.length?t.shift():t.pop();if(e.oldURL===e.newURL)return null;const i=customElements.get("ui-"+n);return i&&!0===i.hasRouting||e.newURL!==location.origin+location.pathname&&n?n:"home"}},UI:{processing:{toDataURL:e=>new Promise((t,n)=>{const i=new Image;i.crossOrigin="Anonymous",i.src=e,setTimeout(()=>{!1===i.complete&&(console.warn("Elara ::: Image loading was too slow, rejecting"),i.src="",n())},1200),i.onload=()=>{const e=document.createElement("canvas"),n=e.getContext("2d");e.height=i.naturalHeight,e.width=i.naturalWidth,n.drawImage(i,0,0),t(e.toDataURL("image/jpeg"))},i.onerror=()=>{n()}})},queries:{DARK:"(prefers-color-scheme: dark)",LIGHT:"(prefers-color-scheme: light)"},modes:{localStorageKey:"night-mode"},typography:{heading:i.b`h1, h2 { user-select: none; font-family: var(--elara-font-display); } h1::first-letter { font-size: 1.3em; } h2::first-letter { font-size: 1.2em }`},elara:()=>document.querySelector("elara-app"),nightSwitchClick:(e,t)=>o(void 0,void 0,void 0,(function*(){e.preventDefault(),e.stopPropagation(),yield t.requestUpdate(),a.UI.elara().askModeChange()})),toggleMode:()=>{const e=document.documentElement.classList.contains("day"),t=document.documentElement.classList.contains("night");return e&&(document.documentElement.classList.remove("day"),document.documentElement.classList.add("night")),t&&(document.documentElement.classList.remove("night"),document.documentElement.classList.add("day")),!0}},Errors:{GenericError:class extends Error{constructor(){super(...arguments),this.elara=!1,this.continue=!0,this.reload=!0}},NotFound:class extends Error{constructor(){super(...arguments),this.elara=!0,this.continue=!0,this.reload=!1}},Prototype:class extends Error{constructor(){super(...arguments),this.elara=!1,this.continue=!0,this.reload=!1}}}};var c=a,l=function(e,t,n,i){var s,r=arguments.length,o=r<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,n):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,n,i);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(o=(r<3?s(o):r>3?s(t,n,o):s(t,n))||o);return r>3&&o&&Object.defineProperty(t,n,o),o},d=function(e,t,n,i){return new(n||(n=Promise))((function(s,r){function o(e){try{c(i.next(e))}catch(e){r(e)}}function a(e){try{c(i.throw(e))}catch(e){r(e)}}function c(e){var t;e.done?s(e.value):(t=e.value,t instanceof n?t:new n((function(e){e(t)}))).then(o,a)}c((i=i.apply(e,t||[])).next())}))};class u extends i.a{connectedCallback(){super.connectedCallback(),window.matchMedia(c.UI.queries.DARK).matches&&document.documentElement.classList.add("night"),window.matchMedia(c.UI.queries.LIGHT).matches&&document.documentElement.classList.add("day"),this._onHashChangeListener=this._onHashChange.bind(this),window.addEventListener("hashchange",this._onHashChangeListener,{passive:!0})}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("hashchange",this._onHashChangeListener)}createRenderRoot(){return this}_onHashChange(e){return d(this,void 0,void 0,(function*(){const t=c.Routing.hashChange(e);this.route=t,this._content.innerHTML="",yield this.load(t)}))}load(e){return d(this,void 0,void 0,(function*(){return c.Bootstrap.load(e,this._content,this._menu,this._menuFade)}))}askModeChange(){c.UI.toggleMode()}get _content(){return this.querySelector("#content")}get _menu(){return this.querySelector("#menu")}}l([Object(i.e)({reflect:!0,type:String})],u.prototype,"route",void 0);var h=function(e,t,n,i){var s,r=arguments.length,o=r<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,n):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,n,i);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(o=(r<3?s(o):r>3?s(t,n,o):s(t,n))||o);return r>3&&o&&Object.defineProperty(t,n,o),o};let p=class extends i.a{constructor(){super(...arguments),this.active=!0}static get styles(){return i.b`
        ...
        `}_pulse(){const e=this.shadowRoot.querySelectorAll(".two-cols section"),t=s(600);e.forEach(e=>{e.animate(t.effect,t.options)})}get _pagination(){return i.d`
        ...
        `}get _spinner(){return this.shadowRoot.querySelector("elara-spinner")}};v.is="ui-github-work",g([Object(i.e)({type:Array})],v.prototype,"repositories",void 0),g([Object(i.e)({type:Array})],v.prototype,"currentPage",void 0),g([Object(i.e)({type:Number,reflect:!0})],v.prototype,"page",void 0),g([Object(i.e)({type:Boolean,reflect:!0})],v.prototype,"inError",void 0),v=g([Object(i.c)("ui-github-work")],v);var y=function(e,t,n,i){var s,r=arguments.length,o=r<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,n):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,n,i);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(o=(r<3?s(o):r>3?s(t,n,o):s(t,n))||o);return r>3&&o&&Object.defineProperty(t,n,o),o},w=function(e,t,n,i){return new(n||(n=Promise))((function(s,r){function o(e){try{c(i.next(e))}catch(e){r(e)}}function a(e){try{c(i.throw(e))}catch(e){r(e)}}function c(e){var t;e.done?s(e.value):(t=e.value,t instanceof n?t:new n((function(e){e(t)}))).then(o,a)}c((i=i.apply(e,t||[])).next())}))};let b=class extends i.a{constructor(){super(...arguments),this.loaded=!1}connectedCallback(){super.connectedCallback(),this._hashChangeListener=this._onHashChange.bind(this),window.addEventListener("hashchange",this._hashChangeListener)}_onProfilePictureLoaded(e){const t=e.target;if(t){const e=r(500,!0);t.animate(e.effect,e.options),t.classList.add("shown"),t.removeEventListener("load",this._onProfilePictureLoaded)}}firstUpdated(){return w(this,void 0,void 0,(function*(){try{this.picture.addEventListener("load",this._onProfilePictureLoaded);const e=yield c.UI.processing.toDataURL("https://source.unsplash.com/collection/1727869/1366x768");if(this.loaded=!0,this.container.style.backgroundImage=`url('${e}')`,this.picture.complete)return void this._onProfilePictureLoaded({target:this.picture,detail:{value:!0}})}catch(e){const t=yield c.UI.processing.toDataURL("/assets/fallback.jpeg");this.container.style.backgroundImage=`url('${t}')`,this.loaded=!0}}))}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("hashchange",this._hashChangeListener)}_onHashChange(e){const t=c.Routing.hashChange(e);this.route=t}render(){return i.d`
        ...
        `}createRenderRoot(){return this}_nightToggle(){return document.documentElement.classList.contains("day")?this._day:this._night}get _day(){return i.d`
        ...
        `}};O=P([Object(i.c)("ui-projects")],O);var E=function(e,t,n,i){var s,r=arguments.length,o=r<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,n):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,n,i);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(o=(r<3?s(o):r>3?s(t,n,o):s(t,n))||o);return r>3&&o&&Object.defineProperty(t,n,o),o};let R=class extends i.a{constructor(e){super(),this.asked=e}static get styles(){return i.b`
        h1, p {
            user-select: none;
            z-index: 1;
        }
        ...
        `}};E([Object(i.e)({type:String,reflect:!0})],R.prototype,"asked",void 0),R=E([Object(i.c)("ui-not-found")],R);var N=function(e,t,n,i){var s,r=arguments.length,o=r<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,n):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,n,i);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(o=(r<3?s(o):r>3?s(t,n,o):s(t,n))||o);return r>3&&o&&Object.defineProperty(t,n,o),o};class L extends i.a{constructor(){super(...arguments),this.items=[],this.route=null,this.shown=!1}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback()}static get styles(){return i.b`
        .menu {
			position: absolute;
			top: 0;
			right: 0;
		...
		`}}L.is="ui-menu",N([Object(i.e)({type:Array,reflect:!1})],L.prototype,"items",void 0),N([Object(i.e)({type:String,reflect:!0})],L.prototype,"route",void 0),N([Object(i.e)({type:Boolean,reflect:!0})],L.prototype,"shown",void 0),customElements.define(L.is,L);var M=function(e,t,n,i){return new(n||(n=Promise))((function(s,r){function o(e){try{c(i.next(e))}catch(e){r(e)}}function a(e){try{c(i.throw(e))}catch(e){r(e)}}function c(e){var t;e.done?s(e.value):(t=e.value,t instanceof n?t:new n((function(e){e(t)}))).then(o,a)}c((i=i.apply(e,t||[])).next())}))};Promise.all([n.e(1),n.e(2)]).then(n.bind(null,15));class T extends u{get loadables(){return[]}get bootstrap(){return c.Bootstrap.promise(this.loadables,this)}show(e){return M(this,void 0,void 0,(function*(){c.Routing.navigate(e),yield this._hideMenu()}))}menu(e){return M(this,void 0,void 0,(function*(){return e?this._hideMenu():this._showMenu()}))}firstUpdated(){const e=new HashChangeEvent("hashchange",{newURL:location.hash,oldURL:null});this._onHashChange(e)}get links(){return[{route:"home",name:"Work"},{route:"about",name:"About"},{route:"projects",name:"Projects"},{route:"contact",name:"Contact"}]}render(){return i.d`
...
//# sourceMappingURL=main.0f204310.js.map