 ...
 * http://polymer.github.io/PATENTS.txt
 */
var u="{{lit-".concat(String(Math.random()).slice(2),"}}"),h="\x3c!--".concat(u,"--\x3e"),d=new RegExp("".concat(u,"|").concat(h)),p=function e(t,n){var r=this;!function(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}(this,e),this.parts=[],this.element=n;var i=-1,o=0,a=[];!function e(n){for(var s=n.content,c=document.createTreeWalker(s,133,null,!1),l=0;c.nextNode();){i++;var h=c.currentNode;if(1===h.nodeType){if(h.hasAttributes()){for(var p=h.attributes,f=0,g=0;g<p.length;g++)p[g].value.indexOf(u)>=0&&f++;for(;f-- >0;){var m=t.strings[o],w=y.exec(m)[2],b=w.toLowerCase()+"$lit$",_=h.getAttribute(b).split(d);r.parts.push({type:"attribute",index:i,name:w,strings:_}),h.removeAttribute(b),o+=_.length-1}}"TEMPLATE"===h.tagName&&e(h)}else if(3===h.nodeType){var x=h.data;if(x.indexOf(u)>=0){for(var k=h.parentNode,S=x.split(d),P=S.length-1,C=0;C<P;C++)k.insertBefore(""===S[C]?v():document.createTextNode(S[C]),h),r.parts.push({type:"node",index:++i});""===S[P]?(k.insertBefore(v(),h),a.push(h)):h.data=S[P],o+=P}}else if(8===h.nodeType)if(h.data===u){var E=h.parentNode;null!==h.previousSibling&&i!==l||(i++,E.insertBefore(v(),h)),l=i,r.parts.push({type:"node",index:i}),null===h.nextSibling?h.data="":(a.push(h),i--),o++}else for(var j=-1;-1!==(j=h.data.indexOf(u,j+1));)r.parts.push({type:"node",index:-1})}}(n);for(var s=0,c=a;s<c.length;s++){var l=c[s];l.parentNode.removeChild(l)}},f=function(e){return-1!==e.index},v=function(){return document.createComment("")},y=/([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F \x09\x0a\x0c\x0d"'>=\/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;function g(e){return function(e){if(Array.isArray(e)){for(var t=0,n=new Array(e.length);t<e.length;t++)n[t]=e[t];return n}}(e)||function(e){if(Symbol.iterator in Object(e)||"[object Arguments]"===Object.prototype.toString.call(e))return Array.from(e)}(e)||function(){throw new TypeError("Invalid attempt to spread non-iterable instance")}()}function m(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
var w=function(){function e(t,n,r){!function(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}(this,e),this._parts=[],this.template=t,this.processor=n,this.options=r}var t,n,r;return t=e,(n=[{key:"update",value:function(e){var t=0,n=!0,r=!1,i=void 0;try{for(var o,a=this._parts[Symbol.iterator]();!(n=(o=a.next()).done);n=!0){var s=o.value;void 0!==s&&s.setValue(e[t]),t++}}catch(e){r=!0,i=e}finally{try{n||null==a.return||a.return()}finally{if(r)throw i}}var c=!0,l=!1,u=void 0;try{for(var h,d=this._parts[Symbol.iterator]();!(c=(h=d.next()).done);c=!0){var p=h.value;void 0!==p&&p.commit()}}catch(e){l=!0,u=e}finally{try{c||null==d.return||d.return()}finally{if(l)throw u}}}},{key:"_clone",value:function(){var e=this,t=o?this.template.element.content.cloneNode(!0):document.importNode(this.template.element.content,!0),n=this.template.parts,r=0,i=0;return function t(o){for(var a=document.createTreeWalker(o,133,null,!1),s=a.nextNode();r<n.length&&null!==s;){var c=n[r];if(f(c))if(i===c.index){if("node"===c.type){var l=e.processor.handleTextExpression(e.options);l.insertAfterNode(s.previousSibling),e._parts.push(l)}else{var u;(u=e._parts).push.apply(u,g(e.processor.handleAttributeExpressions(s,c.name,c.strings,e.options)))}r++}else i++,"TEMPLATE"===s.nodeName&&t(s.content),s=a.nextNode();else e._parts.push(void 0),r++}}(t),o&&(document.adoptNode(t),customElements.upgrade(t)),t}}])&&m(t.prototype,n),r&&m(t,r),e}();function b(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}function x(e,t,n){return t&&_(e.prototype,t),n&&_(e,n),e}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */var k=function(){function e(t,n,r,i){b(this,e),this.strings=t,this.values=n,this.type=r,this.processor=i}return x(e,[{key:"getHTML",value:function(){for(var e=this.strings.length-1,t="",n=0;n<e;n++){var r=this.strings[n],i=y.exec(r);t+=i?r.substr(0,i.index)+i[1]+i[2]+"$lit$"+i[3]+u:r+h}return t+this.strings[e]}},{key:"getTemplateElement",value:function(){var e=document.createElement("template");return e.innerHTML=this.getHTML(),e}}]),e}();function S(e,t){return!t||"object"!==R(t)&&"function"!=typeof t?function(e){if(void 0===e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return e}(e):t}function P(e,t,n){return(P="undefined"!=typeof Reflect&&Reflect.get?Reflect.get:function(e,t,n){var r=function(e,t){for(;!Object.prototype.hasOwnProperty.call(e,t)&&null!==(e=C(e)););return e}(e,t);if(r){var i=Object.getOwnPropertyDescriptor(r,t);return i.get?i.get.call(n):i.value}})(e,t,n||e)}function C(e){return(C=Object.setPrototypeOf?Object.getPrototypeOf:function(e){return e.__proto__||Object.getPrototypeOf(e)})(e)}function E(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function");e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,writable:!0,configurable:!0}}),t&&j(e,t)}function j(e,t){return(j=Object.setPrototypeOf||function(e,t){return e.__proto__=t,e})(e,t)}function O(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function L(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}function N(e,t,n){return t&&L(e.prototype,t),n&&L(e,n),e}function R(e){return(R="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litElementVersions||(window.litElementVersions=[])).push("2.0.1");var $e=function(e){return e.flat?e.flat(1/0):function e(t){for(var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:[],r=0,i=t.length;r<i;r++){var o=t[r];Array.isArray(o)?e(o,n):n.push(o)}return n}(e)},ze=function(e){function t(){return function(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}(this,t),Re(this,Te(t).apply(this,arguments))}var n,r,i;return function(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function");e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,writable:!0,configurable:!0}}),t&&Me(e,t)}(t,_e),n=t,i=[{key:"finalize",value:function(){Ae(Te(t),"finalize",this).call(this),this._styles=this.hasOwnProperty(JSCompiler_renameProperty("styles",this))?this._getUniqueStyles():this._styles||[]}},{key:"_getUniqueStyles",value:function(){var e=this.styles,t=[];Array.isArray(e)?$e(e).reduceRight(function(e,t){return e.add(t),e},new Set).forEach(function(e){return t.unshift(e)}):e&&t.push(e);return t}}],(r=[{key:"initialize",value:function(){Ae(Te(t.prototype),"initialize",this).call(this),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}},{key:"createRenderRoot",value:function(){return this.attachShadow({mode:"open"})}},{key:"adoptStyles",value:function(){var e=this.constructor._styles;0!==e.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?Ce?this.renderRoot.adoptedStyleSheets=e.map(function(e){return e.styleSheet}):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(e.map(function(e){return e.cssText}),this.localName))}},{key:"connectedCallback",value:function(){Ae(Te(t.prototype),"connectedCallback",this).call(this),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}},{key:"update",value:function(e){var n=this;Ae(Te(t.prototype),"update",this).call(this,e);var r=this.render();r instanceof k&&this.constructor.render(r,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach(function(e){var t=document.createElement("style");t.textContent=e.cssText,n.renderRoot.appendChild(t)}))}},{key:"render",value:function(){}}])&&Ne(n.prototype,r),i&&Ne(n,i),t}();ze.finalized=!0,ze.render=function(e,t,n){var r=n.scopeName,i=J.has(t),o=t instanceof ShadowRoot&&te&&e instanceof k,a=o&&!ie.has(r),c=a?document.createDocumentFragment():t;if(function(e,t,n){var r=J.get(t);void 0===r&&(s(t,t.firstChild),J.set(t,r=new $(Object.assign({templateFactory:D},n))),r.appendInto(t)),r.setValue(e),r.commit()}(e,c,Object.assign({templateFactory:ne(r)},n)),a){var l=J.get(c);J.delete(c),l.value instanceof w&&oe(c,l.value.template,r),s(t,t.firstChild),t.appendChild(c),J.set(t,l)}!i&&o&&window.ShadyCSS.styleElement(t.host)};var Ve={Errors:{GenericError:class extends Error{constructor(){super(...arguments),this.elara=!1,this.continue=!0,this.reload=!0}},NotFound:class extends Error{constructor(){super(...arguments),this.elara=!0,this.continue=!0,this.reload=!1}},Prototype:class extends Error{constructor(){super(...arguments),this.elara=!1,this.continue=!0,this.reload=!1}}}};function qe(e){return{effect:{opacity:[.5,1],transform:["scale(.95)","scale(1)"]},options:{duration:e}}}function Ie(e,t){return{effect:{opacity:t?[0,1]:[1,0]},options:{duration:e}}}var Ue,Fe=function(e,t){var n=e.startNode.parentNode,r=void 0===t?e.endNode:t.startNode,i=n.insertBefore(v(),r);n.insertBefore(v(),r);var o=new $(e.options);return o.insertAfterNode(i),o},He=function(e,t){return e.setValue(t),e.commit(),e},Be=function(e,t,n){var r=e.startNode.parentNode,i=n?n.startNode:e.endNode,o=t.endNode.nextSibling;o!==i&&a(r,t.startNode,o,i)},We=function(e){s(e.startNode.parentNode,e.startNode,e.endNode.nextSibling)},De=function(e,t,n){for(var r=new Map,i=t;i<=n;i++)r.set(e[i],i);return r},Ge=new WeakMap,Je=new WeakMap,Ye=(Ue=function(e,t,n){var r;return void 0===n?n=t:void 0!==t&&(r=t),function(t){if(!(t instanceof $))throw new Error("repeat can only be used in text bindings");var i,o,a=Ge.get(t)||[],s=Je.get(t)||[],c=[],l=[],u=[],h=0,d=!0,p=!1,f=void 0;try{for(var v,y=e[Symbol.iterator]();!(d=(v=y.next()).done);d=!0){var g=v.value;u[h]=r?r(g,h):h,l[h]=n(g,h),h++}}catch(e){p=!0,f=e}finally{try{d||null==y.return||y.return()}finally{if(p)throw f}}for(var m=0,w=a.length-1,b=0,_=l.length-1;m<=w&&b<=_;)if(null===a[m])m++;else if(null===a[w])w--;else if(s[m]===u[b])c[b]=He(a[m],l[b]),m++,b++;else if(s[w]===u[_])c[_]=He(a[w],l[_]),w--,_--;else if(s[m]===u[_])c[_]=He(a[m],l[_]),Be(t,a[m],c[_+1]),m++,_--;else if(s[w]===u[b])c[b]=He(a[w],l[b]),Be(t,a[w],a[m]),w--,b++;else if(void 0===i&&(i=De(u,b,_),o=De(s,m,w)),i.has(s[m]))if(i.has(s[w])){var x=o.get(u[b]),k=void 0!==x?a[x]:null;if(null===k){var S=Fe(t,a[m]);He(S,l[b]),c[b]=S}else c[b]=He(k,l[b]),Be(t,k,a[m]),a[x]=null;b++}else We(a[w]),w--;else We(a[m]),m++;for(;b<=_;){var P=Fe(t,c[_+1]);He(P,l[b]),c[b++]=P}for(;m<=w;){var C=a[m++];null!==C&&We(C)}Ge.set(t,c),Je.set(t,u)}},function(){var e=Ue.apply(void 0,arguments);return r.set(e,!0),e}),Qe=function(e,t,n,r){var i,o=arguments.length,a=o<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,n):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(i=e[s])&&(a=(o<3?i(a):o>3?i(t,n,a):i(t,n))||a);return o>3&&a&&Object.defineProperty(t,n,a),a},Ze=function(e,t,n,r){return new(n||(n=Promise))(function(i,o){function a(e){try{c(r.next(e))}catch(e){o(e)}}function s(e){try{c(r.throw(e))}catch(e){o(e)}}function c(e){e.done?i(e.value):new n(function(t){t(e.value)}).then(a,s)}c((r=r.apply(e,t||[])).next())})};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 */class Ke extends ze{constructor(){super(...arguments),this.repositories=[],this.currentPage=null,this.page=0,this.inError=!1,this.chunksLength=6}firstUpdated(){return Ze(this,void 0,void 0,function*(){this._spinner.active=!0;const e=new XMLHttpRequest;e.open("POST","https://api.github.com/graphql",!0),e.setRequestHeader("Authorization","bearer "+atob("ZDQ0Y2JmYjVlOGRiOTRjMjJkNThlYjg4ZjFlNjIyODM4YzQ1N2Q3Mg==")),e.send(JSON.stringify({query:'{ search(query: "user:ghostfly is:public", type: REPOSITORY, first: 100) { repositoryCount edges { node { ... on Repository { name stargazers { totalCount } description forkCount createdAt url primaryLanguage {name} }}}}}'}));const t=()=>{if(!this._spinner)return;this._spinner.active=!1;const e=this._spinner.parentElement;e.removeChild(this._spinner),this.shadowRoot.removeChild(e)},n=()=>{t(),this.inError=!0};e.onerror=n,e.onreadystatechange=(()=>Ze(this,void 0,void 0,function*(){if(4==e.readyState&&200==e.status){const n=JSON.parse(e.responseText).data.search.edges.sort((e,t)=>new Date(t.node.createdAt)-new Date(e.node.createdAt));this.repositories=this._chunk(n,this.chunksLength),this.currentPage=this.repositories[this.page],t(),yield this.updateComplete,this._pulse()}403===e.status&&n()}))})}_chunk(e,t){const n=[],r=e.length;let i=0;for(;i<r;)n.push(e.slice(i,i+=t));return n}static get styles(){return Oe`
        ...
        `}_pulse(){const e=this.shadowRoot.querySelectorAll(".two-cols section"),t=qe(600);e.forEach(e=>{e.animate(t.effect,t.options)})}get _pagination(){return Y`
        <div class="pagination">
            ${this.page+1} / ${this.repositories.length}
            ${this._back} 
            ${this._next}
        </div>`}get _back(){return Y`
        <a role="button" disabled=${0===this.page} @click=${()=>Ze(this,void 0,void 0,function*(){this.page--,this.currentPage=this.repositories[this.page],yield this.updateComplete,this._pulse()})}>
            <paper-icon-button aria-label="Previous page" icon="arrow-back"></paper-icon-button>
        </a>
        `}get _next(){return Y`
        <a role="button" disabled=${this.page+1===this.repositories.length} @click=${()=>Ze(this,void 0,void 0,function*(){this.page++,this.currentPage=this.repositories[this.page],yield this.updateComplete,this._pulse()})}>
            <paper-icon-button aria-label="Next page" icon="arrow-forward"></paper-icon-button>
        </a>
        `}get _spinner(){return this.shadowRoot.querySelector("paper-spinner")}}Ke.is="ui-github-work",Qe([Se({type:Array})],Ke.prototype,"repositories",void 0),Qe([Se({type:Array})],Ke.prototype,"currentPage",void 0),Qe([Se({type:Number,reflect:!0})],Ke.prototype,"page",void 0),Qe([Se({type:Boolean,reflect:!0})],Ke.prototype,"inError",void 0),customElements.define(Ke.is,Ke);var Xe=function(e,t,n,r){var i,o=arguments.length,a=o<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,n):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(i=e[s])&&(a=(o<3?i(a):o>3?i(t,n,a):i(t,n))||a);return o>3&&a&&Object.defineProperty(t,n,a),a},et=function(e,t,n,r){return new(n||(n=Promise))(function(i,o){function a(e){try{c(r.next(e))}catch(e){o(e)}}function s(e){try{c(r.throw(e))}catch(e){o(e)}}function c(e){e.done?i(e.value):new n(function(t){t(e.value)}).then(a,s)}c((r=r.apply(e,t||[])).next())})};class tt extends ze{constructor(){super(...arguments),this.loaded=!1}connectedCallback(){super.connectedCallback(),this.route=location.hash,this._hashChangeListener=this._onHashChange.bind(this),window.addEventListener("hashchange",this._hashChangeListener)}_onProfilePictureLoaded(e){if(!e.detail)return;const t=e.target;if(e.detail.value){const e=Ie(500,!0);t.animate(e.effect,e.options),t.classList.add("shown"),t.removeEventListener("loaded-changed",this._onProfilePictureLoaded)}}firstUpdated(){return et(this,void 0,void 0,function*(){const e=yield this._toDataURL("https://source.unsplash.com/collection/1727869/1366x768");this.container.style.backgroundImage=`url('${e}')`,this.picture.loaded?this._onProfilePictureLoaded({target:this.picture,detail:{value:!0}}):this.picture.addEventListener("loaded-changed",this._onProfilePictureLoaded)})}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("hashchange",this._hashChangeListener)}_toDataURL(e){return new Promise(t=>{const n=new Image;n.crossOrigin="Anonymous",n.onload=(()=>{const e=document.createElement("canvas"),r=e.getContext("2d");e.height=n.naturalHeight,e.width=n.naturalWidth,r.drawImage(n,0,0),this.loaded=!0,t(e.toDataURL("image/jpeg"))}),n.src=e})}_onHashChange(e){e.newURL?this.route=new URL(e.newURL).hash:this.route=null}static get styles(){return Oe`
        .profile {
            width: 24vw;
            padding: 4vh 3vw;
            height: 92vh;
        ...
        `}get picture(){return this.shadowRoot.querySelector("#pic")}get container(){return this.shadowRoot.querySelector("#container")}}tt.is="ui-profile",Xe([Se({type:String,reflect:!0})],tt.prototype,"route",void 0),Xe([Se({type:Boolean,reflect:!0})],tt.prototype,"loaded",void 0),customElements.define(tt.is,tt);class nt extends ze{get head(){return{title:"Work",description:"",type:"page",image:"",slug:"#!home"}}static get styles(){return Oe`
        h1 {
            font-family: var(--elara-font-display);
            user-select: none;
        }
        ...
        <div class="contact">
            ...
            <div class="grid networks">
                ${Ye(this._links,e=>this._makeLink(e.label,e.link,e.svg))}
            </div>
        </div>
        ...
        `}_doSend(e){const t=this.shadowRoot.querySelector("#form"),n=e.target,r=this.shadowRoot.querySelector("#name"),i=this.shadowRoot.querySelector("#email"),o=this.shadowRoot.querySelector("#message");let a=!0;const s=[r,i,o];if(s.forEach(e=>(e=>e.validate())(e)?e.invalid=!1:e.invalid=!0),s.forEach(e=>{e.invalid&&a&&(a=!1)}),a){n.disabled=!0,s.forEach(e=>e.disabled=!0);const e=new FormData;e.append("name",r.value),e.append("email",i.value),e.append("message",o.value);const a=new XMLHttpRequest;a.open("POST","https://script.google.com/macros/s/AKfycbzdhNONz-1pGAlOktko4o5riYGErccxRfk8LsqTxq0ws31wKZ0/exec"),a.onreadystatechange=(()=>{200===a.status&&(this.isSuccess=!0,t.classList.add("sended"))}),a.onerror=(()=>{this.inError=!0}),a.send(e)}}}it.is="ui-contact",rt([Se({type:Boolean,reflect:!0})],it.prototype,"inError",void 0),rt([Se({type:Boolean,reflect:!0})],it.prototype,"isSuccess",void 0),customElements.define(it.is,it);class ot extends ze{get head(){return{title:"About",description:"",type:"page",image:"",slug:"#!about"}}static get styles(){return Oe`
        ...
        `}}ot.is="ui-about",customElements.define(ot.is,ot);var at=function(e,t,n,r){return new(n||(n=Promise))(function(i,o){function a(e){try{c(r.next(e))}catch(e){o(e)}}function s(e){try{c(r.throw(e))}catch(e){o(e)}}function c(e){e.done?i(e.value):new n(function(t){t(e.value)}).then(a,s)}c((r=r.apply(e,t||[])).next())})};class st extends ze{get head(){return{title:"Projects",description:"",type:"page",image:"",slug:"#!projects"}}get projects(){return[{name:"Dandy Costard",slug:"dandy",image:"/assets/projects/dandy.svg",repository:null,status:"Work in progress",url:null,tags:["E-Commerce","Elara","Custom menswear","ThreeJS"]},{name:"Ghostfly.dev",slug:"ghostfly",image:"/assets/me.svg",repository:"https://github.com/Ghostfly/ghostfly.dev/tree/master",status:"Work in progress",url:null,tags:["Elara","LitElement","Github Pages"]},{name:"Persin Conseil",slug:"persin",image:"/assets/projects/persin.jpg",status:"published",repository:"https://github.com/Ghostfly/persin-conseil",url:"https://www.persin.fr",tags:["Lit-Element","Elara","Workbox"]},{name:"Dobrunia Design",slug:"react",image:"/assets/projects/dobrunia.png",status:"published",repository:null,url:"https://www.dobruniadesign.com",tags:["React","HapiJS","Material-UI"]},{name:"Cheno",slug:"cheno",image:"/assets/projects/cheno.svg",status:"published",repository:null,url:"https://www.cheno.fr",tags:["Slim Framework","HTML5","CSS3"]},{name:"Renouveau Sociétal",slug:"rs",image:"/assets/projects/rs.png",status:"published",repository:null,url:"https://www.renouveausocietal.fr",tags:["WordPress","Handmade template"]},{name:"G-Addiction",slug:"g-addiction",image:"/assets/projects/g-addiction.png",status:"published",repository:null,url:"https://www.g-addiction.com",tags:["WordPress","chosen template"]},{name:"Who?",slug:"who",status:"...",repository:null,image:"/assets/projects/who.svg",tags:["?"]}]}_onIronImageLoaded(e){return at(this,void 0,void 0,function*(){if(!e.detail)return;const t=e.target;if(e.detail.value){const e=Ie(500,!0);t.classList.add("shown");const n=t.animate(e.effect,e.options);yield n.finished,t.removeEventListener("loaded-changed",this._onIronImageLoaded)}})}connectedCallback(){const e=Object.create(null,{connectedCallback:{get:()=>super.connectedCallback}});return at(this,void 0,void 0,function*(){e.connectedCallback.call(this),yield this.updateComplete,this.images=this.shadowRoot.querySelectorAll("iron-image"),this.images.forEach(e=>{e.addEventListener("loaded-changed",this._onIronImageLoaded)})})}disconnectedCallback(){super.disconnectedCallback()}static get styles(){return Oe`
        h1, h2 { user-select: none; font-family: var(--elara-font-display); }
        h1::first-letter { font-size: 1.3em; }
        h2::first-letter { font-size: 1.2em }
        ...
        `}}st.is="ui-projects",customElements.define(st.is,st);var ct=function(e,t,n,r){var i,o=arguments.length,a=o<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,n):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(i=e[s])&&(a=(o<3?i(a):o>3?i(t,n,a):i(t,n))||a);return o>3&&a&&Object.defineProperty(t,n,a),a};class lt extends ze{constructor(){super(...arguments),this.height=300,this.width=300}firstUpdated(){const e=this._canvas.getContext("2d");window.requestAnimationFrame(()=>{this._tree(e,600,600,80,-Math.PI/2,13,13)})}static get styles(){return Oe`
        #tree {
            position: fixed;
        }
        `}render(){return Y`<canvas id="tree" height="${this.height}" width="${this.width}"></canvas>`}_tree(e,t,n,r,i,o,a){const s=Math.random;let c,l,u,h;const d=2*Math.PI/4;e.beginPath(),e.moveTo(t,n),u=t+r*Math.cos(i),h=n+r*Math.sin(i),e.lineCap="round",e.lineWidth=a,e.lineTo(u,h),e.strokeStyle=o<=2?"#1095a9":"#333",e.stroke();const p=o-1;if(!p)return;const f=2*s()+1;a*=.7;for(let t=0;t<f;t++)l=i+s()*d-.5*d,c=r*(.7+.3*s()),this._tree(e,u,h,c,l,p,a)}get _canvas(){return this.shadowRoot.querySelector("#tree")}}lt.is="ui-tree",ct([Se({type:Number,reflect:!0})],lt.prototype,"height",void 0),ct([Se({type:Number,reflect:!0})],lt.prototype,"width",void 0),customElements.define(lt.is,lt);var ut=function(e,t,n,r){var i,o=arguments.length,a=o<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,n):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(i=e[s])&&(a=(o<3?i(a):o>3?i(t,n,a):i(t,n))||a);return o>3&&a&&Object.defineProperty(t,n,a),a};class ht extends ze{constructor(e){super(),this.asked=e}static get styles(){return Oe`
        h1, p {
            user-select: none;
            z-index: 1;
        }
        ...
        `}}ht.is="ui-not-found",ut([Se({type:String,reflect:!0})],ht.prototype,"asked",void 0),customElements.define(ht.is,ht),n.d(t,"ElaraApp",function(){return ft});var dt=function(e,t,n,r){var i,o=arguments.length,a=o<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,n):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(i=e[s])&&(a=(o<3?i(a):o>3?i(t,n,a):i(t,n))||a);return o>3&&a&&Object.defineProperty(t,n,a),a},pt=function(e,t,n,r){return new(n||(n=Promise))(function(i,o){function a(e){try{c(r.next(e))}catch(e){o(e)}}function s(e){try{c(r.throw(e))}catch(e){o(e)}}function c(e){e.done?i(e.value):new n(function(t){t(e.value)}).then(a,s)}c((r=r.apply(e,t||[])).next())})};Promise.all([n.e(1),n.e(2)]).then(n.bind(null,59));class ft extends ze{createRenderRoot(){return this.attachShadow({mode:"open"})}connectedCallback(){super.connectedCallback(),this._onHashChangeListener=this._onHashChange.bind(this),window.addEventListener("hashchange",this._onHashChangeListener,{passive:!0})}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("hashchange",this._onHashChangeListener)}_onHashChange(e){const t=e.newURL.replace(location.origin+"/","").split("/")[0];let n=null;if(t){const e=new URL(location.origin+"/"+t).hash.replace("#!","");n=e||"home"}else n="home";this.route!==n&&(this.content.innerHTML="",this.load(n))}load(e){const t="%s | Léonard C.",n=customElements.get("ui-"+e);this.route=e,this.content.classList.remove("full-width");const r=customElements.get("ui-not-found"),i=n?new n:new r(e);if(i.head&&i.head.title?document.title=t.replace("%s",i.head.title):document.title="Léonard C.",!0!==i.isFullWidth||this.content.classList.contains("full-width")?i.isFullWidth||this.content.classList.remove("full-width"):this.content.classList.add("full-width"),this.content.appendChild(i),i instanceof r)throw new Ve.Errors.NotFound(e);window.scrollTo(0,0),this._hideMenu();const o=window.requestAnimationFrame(()=>{if(!i.shadowRoot)return void cancelAnimationFrame(o);const e=i.shadowRoot.querySelector("div");if(!e)return void cancelAnimationFrame(o);const t=qe(600);e.animate(t.effect,t.options)})}firstUpdated(){const e=new HashChangeEvent("hashchange",{newURL:location.hash,oldURL:null});this._onHashChange(e)}static get styles(){return Oe`
		...
		`}get _links(){return[{route:"home",name:"Work"},{route:"about",name:"About"},{route:"projects",name:"Projects"},{route:"contact",name:"Contact"}]}render(){return Y`
			...
			<div id="menu" class="menu-content">
				...
				${Ye(this._links,e=>this._link(e))}
			</div>
		`}_link({route:e,name:t}){return Y`
		<a class="item ${this.route===e?"active":""}" @click=${({target:t})=>this._showLink(t,e)}>${t}</a>
		`}get loadableElements(){return["ui-profile"]}get bootstrap(){const e=[];for(const t of this.loadableElements){const n=new Promise(e=>{const n=this.shadowRoot.querySelector(t),r=new MutationObserver(t=>{t.length&&"attributes"==t[0].type&&"loaded"===t[0].attributeName&&(r.disconnect(),e())});r.observe(n,{attributes:!0})});e.push(n)}return Promise.all(e)}_showLink(e,t){e.disabled=!0,location.hash="#!"+t,window.requestAnimationFrame(()=>{e.disabled=!1})}_showMenu(){return pt(this,void 0,void 0,function*(){this.content.classList.contains("hidden")||this.content.classList.add("hidden"),this.menu.classList.contains("hidden")||this.menu.classList.add("shown");const e=Ie(300,!0);this.menu.animate(e.effect,e.options)})}_hideMenu(){return pt(this,void 0,void 0,function*(){const e=Ie(300,!1),t=this.menu.animate(e.effect,e.options);yield t.finished,this.content.classList.remove("hidden"),this.menu.classList.remove("shown")})}get content(){return this.shadowRoot.querySelector("#content")}get menu(){return this.shadowRoot.querySelector("#menu")}}ft.is="elara-app",dt([Se({reflect:!0,type:String})],ft.prototype,"route",void 0),customElements.define(ft.is,ft)}]);
//# sourceMappingURL=main.eb6b3094.js.map