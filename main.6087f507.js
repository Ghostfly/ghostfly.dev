 ...
 */class nt extends Ue{constructor(){super(...arguments),this.repositories=[],this.currentPage=null,this.page=0,this.inError=!1,this.chunksLength=6}firstUpdated(){return tt(this,void 0,void 0,function*(){this._spinner.active=!0;const e=new XMLHttpRequest;e.open("POST","https://api.github.com/graphql",!0),e.setRequestHeader("Authorization","bearer "+atob("ZDQ0Y2JmYjVlOGRiOTRjMjJkNThlYjg4ZjFlNjIyODM4YzQ1N2Q3Mg==")),e.send(JSON.stringify({query:'{ search(query: "user:ghostfly is:public", type: REPOSITORY, first: 100) { repositoryCount edges { node { ... on Repository { name stargazers { totalCount } description forkCount createdAt url primaryLanguage {name} }}}}}'}));const t=()=>{if(!this._spinner)return;this._spinner.active=!1;const e=this._spinner.parentElement;e.removeChild(this._spinner),this.shadowRoot.removeChild(e)},n=()=>{t(),this.inError=!0};e.onerror=n,e.onreadystatechange=()=>tt(this,void 0,void 0,function*(){if(4==e.readyState&&200==e.status){const n=JSON.parse(e.responseText).data.search.edges.sort((e,t)=>new Date(t.node.createdAt)-new Date(e.node.createdAt));this.repositories=this._chunk(n,this.chunksLength),this.currentPage=this.repositories[this.page],t(),yield this.updateComplete,this._pulse()}403===e.status&&n()})})}_chunk(e,t){const n=[],r=e.length;let i=0;for(;i<r;)n.push(e.slice(i,i+=t));return n}static get styles(){return Ne`
        ...
        `}_pulse(){const e=this.shadowRoot.querySelectorAll(".two-cols section"),t=Ve(600);e.forEach(e=>{e.animate(t.effect,t.options)})}get _pagination(){return Q`
        ...
        <div role="link" id="container" class="profile ${"#!home"!==this.route&&this.route?"is-link":""}" @click=${()=>De.Routing.navigate("home")}>
            ...
            <div class="night-switch" @click=${e=>it(this,void 0,void 0,function*(){return De.UI.nightSwitchClick(e,this)})}>${this._nightToggle()}</div>
        </div>
        ...
        `}_doSend(e){return ct(this,void 0,void 0,function*(){const t={form:this.shadowRoot.querySelector("#form"),submit:e.target,name:this.shadowRoot.querySelector("#name"),email:this.shadowRoot.querySelector("#email"),message:this.shadowRoot.querySelector("#message")};try{(yield De.Mailing.contact(t,"https://script.google.com/macros/s/AKfycbzdhNONz-1pGAlOktko4o5riYGErccxRfk8LsqTxq0ws31wKZ0/exec"))?(this.inError=!1,this.isSuccess=!0):(this.isSuccess=!1,this.inError=!1)}catch(e){console.warn(e),this.inError=!0}})}}lt.is="ui-contact",st([Ce({type:Boolean,reflect:!0})],lt.prototype,"inError",void 0),st([Ce({type:Boolean,reflect:!0})],lt.prototype,"isSuccess",void 0),customElements.define(lt.is,lt);class ut extends Ue{get head(){return{title:"About",description:"",type:"page",image:"",slug:"#!about"}}static get styles(){return Ne`
        ...
        `}}ut.is="ui-about",customElements.define(ut.is,ut);var ht=function(e,t,n,r){return new(n||(n=Promise))(function(i,o){function a(e){try{c(r.next(e))}catch(e){o(e)}}function s(e){try{c(r.throw(e))}catch(e){o(e)}}function c(e){e.done?i(e.value):new n(function(t){t(e.value)}).then(a,s)}c((r=r.apply(e,t||[])).next())})};class dt extends Ue{get head(){return{title:"Projects",description:"",type:"page",image:"",slug:"#!projects"}}get projects(){return[{name:"Listen With Me",slug:"lwm",image:null,repository:null,status:"Work in progress",url:"https://lwm.io",tags:["YouTube","Collaborative","Listening"]},{name:"Dandy Costard",slug:"dandy",image:"/assets/projects/dandy.svg",repository:null,status:"Work in progress",url:null,tags:["E-Commerce","Elara","Custom menswear","ThreeJS"]},{name:"Ghostfly.dev",slug:"ghostfly",image:"/assets/me.svg",repository:"https://github.com/Ghostfly/ghostfly.dev/tree/master",status:"Work in progress",url:null,tags:["Elara","LitElement","Github Pages"]},{name:"Persin Conseil",slug:"persin",image:"/assets/projects/persin.jpg",status:"published",repository:"https://github.com/Ghostfly/persin-conseil",url:"https://www.persin.fr",tags:["Lit-Element","Elara","Workbox"]},{name:"Dobrunia Design",slug:"react",image:"/assets/projects/dobrunia.png",status:"published",repository:null,url:"https://www.dobruniadesign.com",tags:["React","HapiJS","Material-UI"]},{name:"Cheno",slug:"cheno",image:"/assets/projects/cheno.svg",status:"published",repository:null,url:"https://www.cheno.fr",tags:["Slim Framework","HTML5","CSS3"]},{name:"Renouveau Sociétal",slug:"rs",image:"/assets/projects/rs.png",status:"published",repository:null,url:"https://www.renouveausocietal.fr",tags:["WordPress","Handmade template"]},{name:"G-Addiction",slug:"g-addiction",image:"/assets/projects/g-addiction.png",status:"published",repository:null,url:"https://www.g-addiction.com",tags:["WordPress","chosen template"]},{name:"Who?",slug:"who",status:"...",repository:null,url:null,image:"/assets/projects/who.svg",tags:["?"]}]}_onIronImageLoaded(e){return ht(this,void 0,void 0,function*(){if(!e.detail)return;const t=e.target;if(e.detail.value){const e=Fe(500,!0);t.classList.add("shown");const n=t.animate(e.effect,e.options);yield n.finished,t.removeEventListener("loaded-changed",this._onIronImageLoaded)}})}connectedCallback(){const e=Object.create(null,{connectedCallback:{get:()=>super.connectedCallback}});return ht(this,void 0,void 0,function*(){e.connectedCallback.call(this),yield this.updateComplete,this.images=this.shadowRoot.querySelectorAll("iron-image"),this.images.forEach(e=>{e.addEventListener("loaded-changed",this._onIronImageLoaded)})})}disconnectedCallback(){super.disconnectedCallback()}static get styles(){return Ne`
        h1, h2 { user-select: none; font-family: var(--elara-font-display); }
        h1::first-letter { font-size: 1.3em; }
        h2::first-letter { font-size: 1.2em }
		...
		`}}mt.is="ui-menu",gt([Ce({type:Array,reflect:!1})],mt.prototype,"items",void 0),gt([Ce({type:String,reflect:!0})],mt.prototype,"route",void 0),gt([Ce({type:Boolean,reflect:!0})],mt.prototype,"shown",void 0),customElements.define(mt.is,mt),n.d(t,"ElaraApp",function(){return _t});var wt=function(e,t,n,r){var i,o=arguments.length,a=o<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,n):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(i=e[s])&&(a=(o<3?i(a):o>3?i(t,n,a):i(t,n))||a);return o>3&&a&&Object.defineProperty(t,n,a),a},bt=function(e,t,n,r){return new(n||(n=Promise))(function(i,o){function a(e){try{c(r.next(e))}catch(e){o(e)}}function s(e){try{c(r.throw(e))}catch(e){o(e)}}function c(e){e.done?i(e.value):new n(function(t){t(e.value)}).then(a,s)}c((r=r.apply(e,t||[])).next())})};Promise.all([n.e(1),n.e(2)]).then(n.bind(null,59));class _t extends Ue{createRenderRoot(){return this.attachShadow({mode:"open"})}connectedCallback(){super.connectedCallback(),De.UI.applyVariablesFor(De.UI.dayOrNight()),this._onHashChangeListener=this._onHashChange.bind(this),window.addEventListener("hashchange",this._onHashChangeListener,{passive:!0})}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("hashchange",this._onHashChangeListener)}askModeChange(e){return De.UI.applyVariablesFor(e),!0}get loadables(){return["ui-profile"]}get bootstrap(){return De.Bootstrap.promise(this.loadables,this.shadowRoot)}show(e){return bt(this,void 0,void 0,function*(){De.Routing.navigate(e),yield this._hideMenu()})}menu(e){return bt(this,void 0,void 0,function*(){return e?this._hideMenu():this._showMenu()})}load(e){return bt(this,void 0,void 0,function*(){return De.Bootstrap.load(e,this._content,this._menu,this._menuFade)})}firstUpdated(){const e=new HashChangeEvent("hashchange",{newURL:location.hash,oldURL:null});this._onHashChange(e)}static get styles(){return Ne`
