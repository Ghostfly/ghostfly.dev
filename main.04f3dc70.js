 ...
 * http://polymer.github.io/PATENTS.txt
 */
const x=e=>t=>"function"==typeof t?((e,t)=>(window.customElements.define(e,t),t))(e,t):((e,t)=>{const{kind:n,elements:i}=t;return{kind:n,elements:i,finisher(t){window.customElements.define(e,t)}}})(e,t),S=(e,t)=>"method"===t.kind&&t.descriptor&&!("value"in t.descriptor)?Object.assign(Object.assign({},t),{finisher(n){n.createProperty(t.key,e)}}):{kind:"field",key:Symbol(),placement:"own",descriptor:{},initializer(){"function"==typeof t.initializer&&(this[t.key]=t.initializer.call(this))},finisher(n){n.createProperty(t.key,e)}};function P(e){return(t,n)=>void 0!==n?((e,t,n)=>{t.constructor.createProperty(n,e)})(e,t,n):S(e,t)}function C(e){return(t,n)=>{const i={get(){return this.renderRoot.querySelector(e)},enumerable:!0,configurable:!0};return void 0!==n?k(i,t,n):O(i,t)}}function j(e){return(t,n)=>{const i={get(){return this.renderRoot.querySelectorAll(e)},enumerable:!0,configurable:!0};return void 0!==n?k(i,t,n):O(i,t)}}const k=(e,t,n)=>{Object.defineProperty(t,n,e)},O=(e,t)=>({kind:"method",placement:"prototype",key:t.key,descriptor:e});
/**
@license
...
*/
const E="adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,T=Symbol();class N{constructor(e,t){if(t!==T)throw new Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e}get styleSheet(){return void 0===this._styleSheet&&(E?(this._styleSheet=new CSSStyleSheet,this._styleSheet.replaceSync(this.cssText)):this._styleSheet=null),this._styleSheet}toString(){return this.cssText}}const R=(e,...t)=>{const n=t.reduce((t,n,i)=>t+(e=>{if(e instanceof N)return e.cssText;if("number"==typeof e)return e;throw new Error(`Value passed to 'css' function must be a 'css' function result: ${e}. Use 'unsafeCSS' to pass non-literal values, but\n            take care to ensure page security.`)})(n)+e[i+1],e[0]);return new N(n,T)};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class r{constructor(e,t,n){this.__parts=[],this.template=e,this.processor=t,this.options=n}update(e){let t=0;for(const n of this.__parts)void 0!==n&&n.setValue(e[t]),t++;for(const e of this.__parts)void 0!==e&&e.commit()}_clone(){const e=i.a?this.template.element.content.cloneNode(!0):document.importNode(this.template.element.content,!0),t=[],n=this.template.parts,r=document.createTreeWalker(e,133,null,!1);let o,a=0,c=0,l=r.nextNode();for(;a<n.length;)if(o=n[a],Object(s.d)(o)){for(;c<o.index;)c++,"TEMPLATE"===l.nodeName&&(t.push(l),r.currentNode=l.content),null===(l=r.nextNode())&&(r.currentNode=t.pop(),l=r.nextNode());if("node"===o.type){const e=this.processor.handleTextExpression(this.options);e.insertAfterNode(l.previousSibling),this.__parts.push(e)}else this.__parts.push(...this.processor.handleAttributeExpressions(l,o.name,o.strings,this.options));a++}else this.__parts.push(void 0),a++;return i.a&&(document.adoptNode(e),customElements.upgrade(e)),e}}},function(e,t,n){"use strict";n.r(t),n.d(t,"ElaraApp",(function(){return $}));var i=n(0);function s(e){return{effect:{opacity:[.5,1],transform:["scale(.95)","scale(1)"]},options:{duration:e}}}function r(e,t){return{effect:{opacity:t?[0,1]:[1,0]},options:{duration:e}}}var o=function(e,t,n,i){return new(n||(n=Promise))((function(s,r){function o(e){try{c(i.next(e))}catch(e){r(e)}}function a(e){try{c(i.throw(e))}catch(e){r(e)}}function c(e){var t;e.done?s(e.value):(t=e.value,t instanceof n?t:new n((function(e){e(t)}))).then(o,a)}c((i=i.apply(e,t||[])).next())}))};function a(){return document.querySelector("elara-app")}function c(e){return new Promise((t,n)=>{const i=new Image;i.crossOrigin="Anonymous",i.src=e,setTimeout(()=>{!1===i.complete&&(console.warn("Elara ::: Image loading was too slow, rejecting"),i.src="",n())},1200),i.onload=()=>{const e=document.createElement("canvas"),n=e.getContext("2d");e.height=i.naturalHeight,e.width=i.naturalWidth,n.drawImage(i,0,0),t(e.toDataURL("image/jpeg"))},i.onerror=()=>{n()}})}var l=function(e,t,n,i){var s,r=arguments.length,o=r<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,n):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,n,i);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(o=(r<3?s(o):r>3?s(t,n,o):s(t,n))||o);return r>3&&o&&Object.defineProperty(t,n,o),o},d=function(e,t,n,i){return new(n||(n=Promise))((function(s,r){function o(e){try{c(i.next(e))}catch(e){r(e)}}function a(e){try{c(i.throw(e))}catch(e){r(e)}}function c(e){var t;e.done?s(e.value):(t=e.value,t instanceof n?t:new n((function(e){e(t)}))).then(o,a)}c((i=i.apply(e,t||[])).next())}))};class u extends i.a{constructor(){super(...arguments),this.router={redirect:(e,t="_blank")=>!!window.open(e,t),navigate:e=>(location.hash="#!"+e,!0),hashChange(e){const t=e.newURL.replace(location.origin+location.pathname,"").split("#!").filter(Boolean);let n=null;if(n=0===t.length?t.shift():t.pop(),e.oldURL===e.newURL)return null;const i=customElements.get("ui-"+n);return i&&!0===i.hasRouting||e.newURL!==location.origin+location.pathname&&n?n:"home"}},this._queries={DARK:"(prefers-color-scheme: dark)",LIGHT:"(prefers-color-scheme: light)"}}get bootstrap(){return function(e,t){const n=[];for(const i of e){const e=new Promise(e=>{const n=t.querySelector(i),s=new MutationObserver(t=>{t.length&&"attributes"==t[0].type&&"loaded"===t[0].attributeName&&(s.disconnect(),e())});s.observe(n,{attributes:!0})});n.push(e)}return Promise.all(n)}(this.loadables,this)}show(e){return d(this,void 0,void 0,(function*(){this.router.navigate(e),this.hideMenu()}))}connectedCallback(){super.connectedCallback(),window.matchMedia(this._queries.DARK).matches&&document.body.classList.add("night"),window.matchMedia(this._queries.LIGHT).matches&&document.body.classList.add("day"),this._onHashChangeListener=this._onHashChange.bind(this),window.addEventListener("hashchange",this._onHashChangeListener,{passive:!0})}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("hashchange",this._onHashChangeListener)}createRenderRoot(){return this}switchColors(){const e=document.body.classList.contains("day"),t=document.body.classList.contains("night");return e&&(document.body.classList.remove("day"),document.body.classList.add("night")),t&&(document.body.classList.remove("night"),document.body.classList.add("day")),{day:e,night:t}}firstUpdated(){const e=new HashChangeEvent("hashchange",{newURL:location.hash,oldURL:null});this._onHashChange(e)}_onHashChange(e){return d(this,void 0,void 0,(function*(){const t=this.router.hashChange(e);this.route=t,this._content.innerHTML="",yield this.load(t)}))}load(e){return d(this,void 0,void 0,(function*(){return this._content.scrollTop=0,function(e,t,n,i){return o(this,void 0,void 0,(function*(){const r="%s | Léonard Cherouvrier",o=customElements.get("ui-"+e);t.classList.remove("full-width");const c=customElements.get("ui-not-found"),l=o?new o:new c(e);if(l.head&&l.head.title?document.title=r.replace("%s",l.head.title):document.title="Léonard Cherouvrier",!0!==l.isFullWidth||t.classList.contains("full-width")?l.isFullWidth||t.classList.remove("full-width"):t.classList.add("full-width"),t.appendChild(l),l instanceof c)throw new Error(e);window.scrollTo(0,0),n.shown&&null===i&&(yield a().hideMenu());const d=window.requestAnimationFrame(()=>{const e=l.querySelector("div");if(!e)return void cancelAnimationFrame(d);const t=s(300);e.animate(t.effect,t.options)})}))}(e,this._content,this._menu,this._menuFade)}))}}l([Object(i.e)({reflect:!0,type:String})],u.prototype,"route",void 0),l([Object(i.f)("#content")],u.prototype,"_content",void 0),l([Object(i.f)("#menu")],u.prototype,"_menu",void 0);var h=function(e,t,n,i){var s,r=arguments.length,o=r<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,n):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,n,i);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(o=(r<3?s(o):r>3?s(t,n,o):s(t,n))||o);return r>3&&o&&Object.defineProperty(t,n,o),o};let p=class extends i.a{constructor(){super(...arguments),this.active=!0,this.text="Loading"}static get styles(){return i.b`
        :host {
          height: 100%;
          width: 100%;
        }
        ...
        `}_cardT(e){return i.d`
        <section class="github-card" @click=${()=>a().router.redirect(e.node.url)}}>
        ...
        <div class="pagination">
            ${this.currentPage?this._paginationT:i.d``}
            <div class="global">
                <a class="next" @click=${()=>a().router.navigate("about")}>> About</a>
            </div>
        </div>
        ...
        `}};y([Object(i.e)({type:String,reflect:!0})],w.prototype,"route",void 0),y([Object(i.e)({type:Boolean,reflect:!0})],w.prototype,"loaded",void 0),y([Object(i.f)("#pic")],w.prototype,"picture",void 0),y([Object(i.f)("#container")],w.prototype,"container",void 0),y([Object(i.e)({type:Object,reflect:!1,noAccessor:!0})],w.prototype,"_toggle",void 0),w=y([Object(i.c)("ui-profile")],w);var _=function(e,t,n,i){var s,r=arguments.length,o=r<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,n):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,n,i);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(o=(r<3?s(o):r>3?s(t,n,o):s(t,n))||o);return r>3&&o&&Object.defineProperty(t,n,o),o};let x=class extends f{get head(){return{title:"Work",description:"",type:"page",image:"",slug:"#!home"}}render(){return i.d`
        <div class="home">
        ...
        <div class="contact">
            ...
            <div class="pagination">
                <a class="prev" @click=${()=>a().router.navigate("projects")}>< Projects</a>
            </div>
        </div>`}_makeLink(e,t,n){return i.d`
            <div aria-label=${e} class="item ${e.toLowerCase()}" @click=${()=>{a().router.redirect(t)}} role="link">
                ${n}
            </div>
        `}};P=S([Object(i.c)("ui-contact")],P);var C=function(e,t,n,i){var s,r=arguments.length,o=r<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,n):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,n,i);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(o=(r<3?s(o):r>3?s(t,n,o):s(t,n))||o);return r>3&&o&&Object.defineProperty(t,n,o),o};let j=class extends f{get head(){return{title:"About",description:"",type:"page",image:"",slug:"#!about"}}render(){return i.d`
        <div class="about">
            <h1>${this.head.title}</h1>
            <div class="row">
            ...
            <div class="row">
                ...
                <div>
                    ...
                    <a role="link" class="cv" @click=${()=>a().router.redirect("/assets/resume.pdf")}>CV</a> (Update in progress).</p>
                </div>
            </div>
            <div class="pagination">
                <a class="prev" @click=${()=>a().router.navigate("home")}>< Work</a>
                <a class="next" @click=${()=>a().router.navigate("projects")}>> Projects</a>
            </div>
        </div>
        `}};j=C([Object(i.c)("ui-about")],j);var k=function(e,t,n,i){var s,r=arguments.length,o=r<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,n):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,n,i);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(o=(r<3?s(o):r>3?s(t,n,o):s(t,n))||o);return r>3&&o&&Object.defineProperty(t,n,o),o},O=function(e,t,n,i){return new(n||(n=Promise))((function(s,r){function o(e){try{c(i.next(e))}catch(e){r(e)}}function a(e){try{c(i.throw(e))}catch(e){r(e)}}function c(e){var t;e.done?s(e.value):(t=e.value,t instanceof n?t:new n((function(e){e(t)}))).then(o,a)}c((i=i.apply(e,t||[])).next())}))};let E=class extends f{get head(){return{title:"Projects",description:"",type:"page",image:"",slug:"#!projects"}}get projects(){return[{name:"Dandy Costard",slug:"dandy",image:"/assets/projects/dandy.svg",repository:null,status:"Work in progress",url:null,tags:["E-Commerce","Elara"]},{name:"Persin Conseil",slug:"persin",image:"/assets/projects/persin.jpg",status:"published",repository:"https://github.com/Ghostfly/persin-conseil",url:"https://www.persin.fr",tags:["Lit-Element","Offline ready","structured data","no-js capable"]},{name:"Ghostfly.dev",slug:"ghostfly",image:"/assets/me.svg",repository:"https://github.com/Ghostfly/ghostfly.dev/tree/master",status:"published",url:"https://ghostfly.dev",tags:["Elara","LitElement","Github Pages"]},{name:"Cheno",slug:"cheno",image:"/assets/projects/cheno.svg",status:"published",repository:"https://github.com/ghostfly/cheno-website",url:"https://www.cheno.fr",tags:["Elara","Headless Wordpress"]},{name:"Dobrunia Design",slug:"dobrunia",image:"/assets/projects/dobrunia.png",status:"published",repository:"https://github.com/ghostfly/dobrunia-design",url:"https://www.dobruniadesign.com",tags:["Elara","Headless Wordpress"]}]}_onImageLoaded(e){return O(this,void 0,void 0,(function*(){const t=e.target;if(t){const e=r(500,!0);t.classList.add("shown");const n=t.animate(e.effect,e.options);yield n.finished,t.removeEventListener("load",this._onImageLoaded)}}))}connectedCallback(){const e=Object.create(null,{connectedCallback:{get:()=>super.connectedCallback}});return O(this,void 0,void 0,(function*(){e.connectedCallback.call(this),yield this.updateComplete,this.images=this.querySelectorAll("img"),this.images.forEach(e=>{e.addEventListener("load",this._onImageLoaded)})}))}_card(e){return i.d`
        <section class="project">
            <div class="hidden-content project-grid">
                <div class="left">
                    <h3 class="${e.slug} ${e.url?"with-link":"normal"}" role="${e.url?"link":"title"}"  @click=${()=>{e.url&&a().router.redirect(e.url)}}>${e.name}</h3>
                    <div class="tags">
                        ${e.tags.join(", ")}
                    </div>
                    <br />
                    <div class="status ${e.repository?"enabled":"disabled"}" @click=${()=>{e.repository&&a().router.redirect(e.repository)}}>
                ...
                <div class="right ${e.image?"enabled":"disabled"}" @click=${()=>{e.url&&a().router.redirect(e.url)}}>
        ...
        <div class="projects">
            ...
            <div class="pagination">
                <a class="prev" @click=${()=>a().router.navigate("about")}>< About</a>
                <a class="next" @click=${()=>a().router.navigate("contact")}>> Contact</a>
            </div>
        </div>
        `}};E=k([Object(i.c)("ui-projects")],E);var T=function(e,t,n,i){var s,r=arguments.length,o=r<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,n):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,n,i);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(o=(r<3?s(o):r>3?s(t,n,o):s(t,n))||o);return r>3&&o&&Object.defineProperty(t,n,o),o};let N=class extends i.a{constructor(e){super(),this.asked=e}static get styles(){return i.b`
        h1, p {
            user-select: none;
            z-index: 1;
        }
        ...
        <div>
            ...
            <a @click=${()=>a().router.navigate("home")}><mwc-icon icon="home"></mwc-icon> Homepage</a>
        </div>
        `}};T([Object(i.e)({type:String,reflect:!0})],N.prototype,"asked",void 0),N=T([Object(i.c)("ui-not-found")],N);var R=function(e,t,n,i){var s,r=arguments.length,o=r<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,n):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,n,i);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(o=(r<3?s(o):r>3?s(t,n,o):s(t,n))||o);return r>3&&o&&Object.defineProperty(t,n,o),o};let L=class extends i.a{constructor(){super(...arguments),this.items=[],this.route=null,this.shown=!1}createRenderRoot(){return this}render(){return i.d`
        <div class="menu-content ${!0===this.shown?"shown":""}">
			${this.items.map(e=>this._link(e))}
		</div>
        `}_link({route:e,name:t}){return i.d`
		<a class="item ${this.route===e?"active":""}" @click=${()=>a().show(e)}>${t}</a>
		`}};R([Object(i.e)({type:Array,reflect:!1})],L.prototype,"items",void 0),R([Object(i.e)({type:String,reflect:!0})],L.prototype,"route",void 0),R([Object(i.e)({type:Boolean,reflect:!0})],L.prototype,"shown",void 0),L=R([Object(i.c)("ui-menu")],L);var M=function(e,t,n,i){var s,r=arguments.length,o=r<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,n):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,n,i);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(o=(r<3?s(o):r>3?s(t,n,o):s(t,n))||o);return r>3&&o&&Object.defineProperty(t,n,o),o},A=function(e,t,n,i){return new(n||(n=Promise))((function(s,r){function o(e){try{c(i.next(e))}catch(e){r(e)}}function a(e){try{c(i.throw(e))}catch(e){r(e)}}function c(e){var t;e.done?s(e.value):(t=e.value,t instanceof n?t:new n((function(e){e(t)}))).then(o,a)}c((i=i.apply(e,t||[])).next())}))};Promise.all([n.e(2),n.e(1)]).then(n.bind(null,15));let $=class extends u{get loadables(){return["ui-profile"]}get links(){return[{route:"home",name:"Work"},{route:"about",name:"About"},{route:"projects",name:"Projects"},{route:"contact",name:"Contact"}]}render(){return i.d`
...
//# sourceMappingURL=main.04f3dc70.js.map