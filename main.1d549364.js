 ...
 * http://polymer.github.io/PATENTS.txt
 */
var u="{{lit-".concat(String(Math.random()).slice(2),"}}"),h="\x3c!--".concat(u,"--\x3e"),d=new RegExp("".concat(u,"|").concat(h)),p=function e(t,n){!function(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}(this,e),this.parts=[],this.element=n;for(var r=[],i=[],o=document.createTreeWalker(n.content,133,null,!1),a=0,s=-1,c=0,l=t.strings,h=t.values.length;c<h;){var p=o.nextNode();if(null!==p){if(s++,1===p.nodeType){if(p.hasAttributes()){for(var v=p.attributes,m=v.length,w=0,b=0;b<m;b++)f(v[b].name,"$lit$")&&w++;for(;w-- >0;){var _=l[c],x=g.exec(_)[2],k=x.toLowerCase()+"$lit$",S=p.getAttribute(k);p.removeAttribute(k);var P=S.split(d);this.parts.push({type:"attribute",index:s,name:x,strings:P}),c+=P.length-1}}"TEMPLATE"===p.tagName&&(i.push(p),o.currentNode=p.content)}else if(3===p.nodeType){var C=p.data;if(C.indexOf(u)>=0){for(var E=p.parentNode,O=C.split(d),j=O.length-1,R=0;R<j;R++){var N=void 0,L=O[R];if(""===L)N=y();else{var T=g.exec(L);null!==T&&f(T[2],"$lit$")&&(L=L.slice(0,T.index)+T[1]+T[2].slice(0,-"$lit$".length)+T[3]),N=document.createTextNode(L)}E.insertBefore(N,p),this.parts.push({type:"node",index:++s})}""===O[j]?(E.insertBefore(y(),p),r.push(p)):p.data=O[j],c+=j}}else if(8===p.nodeType)if(p.data===u){var A=p.parentNode;null!==p.previousSibling&&s!==a||(s++,A.insertBefore(y(),p)),a=s,this.parts.push({type:"node",index:s}),null===p.nextSibling?p.data="":(r.push(p),s--),c++}else for(var M=-1;-1!==(M=p.data.indexOf(u,M+1));)this.parts.push({type:"node",index:-1}),c++}else o.currentNode=i.pop()}for(var z=0,$=r;z<$.length;z++){var I=$[z];I.parentNode.removeChild(I)}},f=function(e,t){var n=e.length-t.length;return n>=0&&e.slice(n)===t},v=function(e){return-1!==e.index},y=function(){return document.createComment("")},g=/([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=\/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;function m(e){return function(e){if(Array.isArray(e)){for(var t=0,n=new Array(e.length);t<e.length;t++)n[t]=e[t];return n}}(e)||function(e){if(Symbol.iterator in Object(e)||"[object Arguments]"===Object.prototype.toString.call(e))return Array.from(e)}(e)||function(){throw new TypeError("Invalid attempt to spread non-iterable instance")}()}function w(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */var S=function(){function e(t,n,r,i){_(this,e),this.strings=t,this.values=n,this.type=r,this.processor=i}return k(e,[{key:"getHTML",value:function(){for(var e=this.strings.length-1,t="",n=!1,r=0;r<e;r++){var i=this.strings[r],o=i.lastIndexOf("\x3c!--");n=(o>-1||n)&&-1===i.indexOf("--\x3e",o+1);var a=g.exec(i);t+=null===a?i+(n?u:h):i.substr(0,a.index)+a[1]+a[2]+"$lit$"+a[3]+u}return t+=this.strings[e]}},{key:"getTemplateElement",value:function(){var e=document.createElement("template");return e.innerHTML=this.getHTML(),e}}]),e}();function P(e,t){return!t||"object"!==T(t)&&"function"!=typeof t?function(e){if(void 0===e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return e}(e):t}function C(e,t,n){return(C="undefined"!=typeof Reflect&&Reflect.get?Reflect.get:function(e,t,n){var r=function(e,t){for(;!Object.prototype.hasOwnProperty.call(e,t)&&null!==(e=E(e)););return e}(e,t);if(r){var i=Object.getOwnPropertyDescriptor(r,t);return i.get?i.get.call(n):i.value}})(e,t,n||e)}function E(e){return(E=Object.setPrototypeOf?Object.getPrototypeOf:function(e){return e.__proto__||Object.getPrototypeOf(e)})(e)}function O(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function");e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,writable:!0,configurable:!0}}),t&&j(e,t)}function j(e,t){return(j=Object.setPrototypeOf||function(e,t){return e.__proto__=t,e})(e,t)}function R(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function N(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}function L(e,t,n){return t&&N(e.prototype,t),n&&N(e,n),e}function T(e){return(T="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
var G=new(function(){function e(){!function(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}(this,e)}var t,n,r;return t=e,(n=[{key:"handleAttributeExpressions",value:function(e,t,n,r){var i=t[0];return"."===i?new V(e,t.slice(1),n).parts:"@"===i?[new B(e,t.slice(1),r.eventContext)]:"?"===i?[new U(e,t.slice(1),n)]:new z(e,t,n).parts}},{key:"handleTextExpression",value:function(e){return new I(e)}}])&&W(t.prototype,n),r&&W(t,r),e}());
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litElementVersions||(window.litElementVersions=[])).push("2.0.1");var Ie=function(e){return e.flat?e.flat(1/0):function e(t){for(var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:[],r=0,i=t.length;r<i;r++){var o=t[r];Array.isArray(o)?e(o,n):n.push(o)}return n}(e)},Ue=function(e){function t(){return function(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}(this,t),Ae(this,ze(t).apply(this,arguments))}var n,r,i;return function(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function");e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,writable:!0,configurable:!0}}),t&&$e(e,t)}(t,ke),n=t,i=[{key:"finalize",value:function(){Me(ze(t),"finalize",this).call(this),this._styles=this.hasOwnProperty(JSCompiler_renameProperty("styles",this))?this._getUniqueStyles():this._styles||[]}},{key:"_getUniqueStyles",value:function(){var e=this.styles,t=[];Array.isArray(e)?Ie(e).reduceRight(function(e,t){return e.add(t),e},new Set).forEach(function(e){return t.unshift(e)}):e&&t.push(e);return t}}],(r=[{key:"initialize",value:function(){Me(ze(t.prototype),"initialize",this).call(this),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}},{key:"createRenderRoot",value:function(){return this.attachShadow({mode:"open"})}},{key:"adoptStyles",value:function(){var e=this.constructor._styles;0!==e.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?Oe?this.renderRoot.adoptedStyleSheets=e.map(function(e){return e.styleSheet}):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(e.map(function(e){return e.cssText}),this.localName))}},{key:"connectedCallback",value:function(){Me(ze(t.prototype),"connectedCallback",this).call(this),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}},{key:"update",value:function(e){var n=this;Me(ze(t.prototype),"update",this).call(this,e);var r=this.render();r instanceof S&&this.constructor.render(r,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach(function(e){var t=document.createElement("style");t.textContent=e.cssText,n.renderRoot.appendChild(t)}))}},{key:"render",value:function(){}}])&&Te(n.prototype,r),i&&Te(n,i),t}();Ue.finalized=!0,Ue.render=function(e,t,n){var r=n.scopeName,i=K.has(t),o=re&&11===t.nodeType&&!!t.host&&e instanceof S,a=o&&!ae.has(r),c=a?document.createDocumentFragment():t;if(function(e,t,n){var r=K.get(t);void 0===r&&(s(t,t.firstChild),K.set(t,r=new I(Object.assign({templateFactory:J},n))),r.appendInto(t)),r.setValue(e),r.commit()}(e,c,Object.assign({templateFactory:ie(r)},n)),a){var l=K.get(c);K.delete(c),l.value instanceof b&&se(c,l.value.template,r),s(t,t.firstChild),t.appendChild(c),K.set(t,l)}!i&&o&&window.ShadyCSS.styleElement(t.host)};var Ve=function(e,t,n,r){return new(n||(n=Promise))(function(i,o){function a(e){try{c(r.next(e))}catch(e){o(e)}}function s(e){try{c(r.throw(e))}catch(e){o(e)}}function c(e){e.done?i(e.value):new n(function(t){t(e.value)}).then(a,s)}c((r=r.apply(e,t||[])).next())})};const Fe={Bootstrap:{promise:(e,t)=>{const n=[];for(const r of e){const e=new Promise(e=>{const n=t.querySelector(r),i=new MutationObserver(t=>{t.length&&"attributes"==t[0].type&&"loaded"===t[0].attributeName&&(i.disconnect(),e())});i.observe(n,{attributes:!0})});n.push(e)}return Promise.all(n)}},Constants:{modes:{default:"day"}},Routing:{redirect:(e,t="_blank")=>!!window.open(e,t),navigate:e=>(location.hash=`#!${e}`,!0),hashChange:(e,t)=>{const n=e.newURL.replace(location.origin+"/","").split("/")[0];let r=null;if(n){const e=new URL(location.origin+"/"+n).hash.replace("#!","");r=e||"home"}else r="home";return t===r?null:r}},UI:{queries:{DARK:"(prefers-color-scheme: dark)",LIGHT:"(prefers-color-scheme: light)"},modes:{localStorageKey:"night-mode"},elara:()=>document.querySelector("elara-app"),mode:()=>localStorage.getItem(Fe.UI.modes.localStorageKey),nightSwitchClick:(e,t)=>Ve(void 0,void 0,void 0,function*(){e.preventDefault(),e.stopPropagation();const n=!Fe.UI.isSunny()?"day":"night";return localStorage.setItem(Fe.UI.modes.localStorageKey,n),yield t.requestUpdate(),Fe.UI.elara().askModeChange(n)}),applyVariablesFor:e=>{const t=document.documentElement;return"night"===e?(t.style.setProperty("--elara-background-color","#373737"),t.style.setProperty("--elara-font-color","#f0f0f0"),t.style.setProperty("--elara-font-hover","#9e9e9e")):(t.style.removeProperty("--elara-background-color"),t.style.removeProperty("--elara-font-color"),t.style.removeProperty("--elara-font-hover")),!0},hasSwitched:()=>null!==Fe.UI.mode(),isSunny:()=>"day"===Fe.UI.mode(),dayOrNight:()=>Fe.UI.hasSwitched()?Fe.UI.isSunny()?"day":"night":Fe.UI.isDarkOS()?"day":"night",isDarkOS:()=>window.matchMedia?window.matchMedia(Fe.UI.queries.DARK).matches:(console.warn("Elara:: Night mode not supported at the moment"),!1)},Mailing:{contact:(e,t)=>Ve(void 0,void 0,void 0,function*(){let n=!0;const r=[e.name,e.email,e.message];if(r.forEach(e=>(e=>e.validate())(e)?e.invalid=!1:e.invalid=!0),r.forEach(e=>{e.invalid&&n&&(n=!1)}),!n)return n;e.submit.disabled=!0,r.forEach(e=>e.disabled=!0);const i=new FormData;return i.append("name",e.name.value),i.append("email",e.email.value),i.append("message",e.message.value),new Promise((n,r)=>{const o=new XMLHttpRequest;o.open("POST",t),o.onreadystatechange=()=>{200===o.status&&(e.form.classList.add("sended"),n(!0))},o.onerror=()=>{r(!1)},o.send(i)})})},Errors:{GenericError:class extends Error{constructor(){super(...arguments),this.elara=!1,this.continue=!0,this.reload=!0}},NotFound:class extends Error{constructor(){super(...arguments),this.elara=!0,this.continue=!0,this.reload=!1}},Prototype:class extends Error{constructor(){super(...arguments),this.elara=!1,this.continue=!0,this.reload=!1}}}};var qe=Fe;function He(e){return{effect:{opacity:[.5,1],transform:["scale(.95)","scale(1)"]},options:{duration:e}}}function Be(e,t){return{effect:{opacity:t?[0,1]:[1,0]},options:{duration:e}}}var De,We=function(e,t){var n=e.startNode.parentNode,r=void 0===t?e.endNode:t.startNode,i=n.insertBefore(y(),r);n.insertBefore(y(),r);var o=new I(e.options);return o.insertAfterNode(i),o},Ge=function(e,t){return e.setValue(t),e.commit(),e},Je=function(e,t,n){var r=e.startNode.parentNode,i=n?n.startNode:e.endNode,o=t.endNode.nextSibling;o!==i&&a(r,t.startNode,o,i)},Ye=function(e){s(e.startNode.parentNode,e.startNode,e.endNode.nextSibling)},Ke=function(e,t,n){for(var r=new Map,i=t;i<=n;i++)r.set(e[i],i);return r},Qe=new WeakMap,Ze=new WeakMap,Xe=(De=function(e,t,n){var r;return void 0===n?n=t:void 0!==t&&(r=t),function(t){if(!(t instanceof I))throw new Error("repeat can only be used in text bindings");var i,o,a=Qe.get(t)||[],s=Ze.get(t)||[],c=[],l=[],u=[],h=0,d=!0,p=!1,f=void 0;try{for(var v,y=e[Symbol.iterator]();!(d=(v=y.next()).done);d=!0){var g=v.value;u[h]=r?r(g,h):h,l[h]=n(g,h),h++}}catch(e){p=!0,f=e}finally{try{d||null==y.return||y.return()}finally{if(p)throw f}}for(var m=0,w=a.length-1,b=0,_=l.length-1;m<=w&&b<=_;)if(null===a[m])m++;else if(null===a[w])w--;else if(s[m]===u[b])c[b]=Ge(a[m],l[b]),m++,b++;else if(s[w]===u[_])c[_]=Ge(a[w],l[_]),w--,_--;else if(s[m]===u[_])c[_]=Ge(a[m],l[_]),Je(t,a[m],c[_+1]),m++,_--;else if(s[w]===u[b])c[b]=Ge(a[w],l[b]),Je(t,a[w],a[m]),w--,b++;else if(void 0===i&&(i=Ke(u,b,_),o=Ke(s,m,w)),i.has(s[m]))if(i.has(s[w])){var x=o.get(u[b]),k=void 0!==x?a[x]:null;if(null===k){var S=We(t,a[m]);Ge(S,l[b]),c[b]=S}else c[b]=Ge(k,l[b]),Je(t,k,a[m]),a[x]=null;b++}else Ye(a[w]),w--;else Ye(a[m]),m++;for(;b<=_;){var P=We(t,c[_+1]);Ge(P,l[b]),c[b++]=P}for(;m<=w;){var C=a[m++];null!==C&&Ye(C)}Qe.set(t,c),Ze.set(t,u)}},function(){var e=De.apply(void 0,arguments);return r.set(e,!0),e}),et=function(e,t,n,r){var i,o=arguments.length,a=o<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,n):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(i=e[s])&&(a=(o<3?i(a):o>3?i(t,n,a):i(t,n))||a);return o>3&&a&&Object.defineProperty(t,n,a),a},tt=function(e,t,n,r){return new(n||(n=Promise))(function(i,o){function a(e){try{c(r.next(e))}catch(e){o(e)}}function s(e){try{c(r.throw(e))}catch(e){o(e)}}function c(e){e.done?i(e.value):new n(function(t){t(e.value)}).then(a,s)}c((r=r.apply(e,t||[])).next())})};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 */class nt extends Ue{constructor(){super(...arguments),this.repositories=[],this.currentPage=null,this.page=0,this.inError=!1,this.chunksLength=6}firstUpdated(){return tt(this,void 0,void 0,function*(){this._spinner.active=!0;const e=new XMLHttpRequest;e.open("POST","https://api.github.com/graphql",!0),e.setRequestHeader("Authorization","bearer "+atob("ZDQ0Y2JmYjVlOGRiOTRjMjJkNThlYjg4ZjFlNjIyODM4YzQ1N2Q3Mg==")),e.send(JSON.stringify({query:'{ search(query: "user:ghostfly is:public", type: REPOSITORY, first: 100) { repositoryCount edges { node { ... on Repository { name stargazers { totalCount } description forkCount createdAt url primaryLanguage {name} }}}}}'}));const t=()=>{if(!this._spinner)return;this._spinner.active=!1;const e=this._spinner.parentElement;e.removeChild(this._spinner),this.shadowRoot.removeChild(e)},n=()=>{t(),this.inError=!0};e.onerror=n,e.onreadystatechange=()=>tt(this,void 0,void 0,function*(){if(4==e.readyState&&200==e.status){const n=JSON.parse(e.responseText).data.search.edges.sort((e,t)=>new Date(t.node.createdAt)-new Date(e.node.createdAt));this.repositories=this._chunk(n,this.chunksLength),this.currentPage=this.repositories[this.page],t(),yield this.updateComplete,this._pulse()}403===e.status&&n()})})}_chunk(e,t){const n=[],r=e.length;let i=0;for(;i<r;)n.push(e.slice(i,i+=t));return n}static get styles(){return Ne`
        ...
        `}_card(e){return Q`
        <section class="github-card" @click=${()=>qe.Routing.redirect(e.node.url)}}>
        ...
        ${this.currentPage?Q`
        <div class="two-cols">
            ${Xe(this.currentPage,this._card)}
        </div>
        ${this._pagination}
        `:Q``}
        <a class="next" @click=${()=>qe.Routing.navigate("about")}>> About</a>
        `}_pulse(){const e=this.shadowRoot.querySelectorAll(".two-cols section"),t=He(600);e.forEach(e=>{e.animate(t.effect,t.options)})}get _pagination(){return Q`
        <div class="pagination">
            ${this.page+1} / ${this.repositories.length}
            ${this._back} 
            ${this._next}
        </div>`}get _back(){return Q`
        <a role="button" disabled=${0===this.page} @click=${()=>tt(this,void 0,void 0,function*(){this.page--,this.currentPage=this.repositories[this.page],yield this.updateComplete,this._pulse()})}>
            <paper-icon-button aria-label="Previous page" icon="arrow-back"></paper-icon-button>
        </a>
        `}get _next(){return Q`
        <a role="button" disabled=${this.page+1===this.repositories.length} @click=${()=>tt(this,void 0,void 0,function*(){this.page++,this.currentPage=this.repositories[this.page],yield this.updateComplete,this._pulse()})}>
            <paper-icon-button aria-label="Next page" icon="arrow-forward"></paper-icon-button>
        </a>
        `}get _spinner(){return this.shadowRoot.querySelector("paper-spinner")}}nt.is="ui-github-work",et([Ce({type:Array})],nt.prototype,"repositories",void 0),et([Ce({type:Array})],nt.prototype,"currentPage",void 0),et([Ce({type:Number,reflect:!0})],nt.prototype,"page",void 0),et([Ce({type:Boolean,reflect:!0})],nt.prototype,"inError",void 0),customElements.define(nt.is,nt);var rt=function(e,t,n,r){var i,o=arguments.length,a=o<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,n):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(i=e[s])&&(a=(o<3?i(a):o>3?i(t,n,a):i(t,n))||a);return o>3&&a&&Object.defineProperty(t,n,a),a},it=function(e,t,n,r){return new(n||(n=Promise))(function(i,o){function a(e){try{c(r.next(e))}catch(e){o(e)}}function s(e){try{c(r.throw(e))}catch(e){o(e)}}function c(e){e.done?i(e.value):new n(function(t){t(e.value)}).then(a,s)}c((r=r.apply(e,t||[])).next())})};class ot extends Ue{constructor(){super(...arguments),this.loaded=!1}connectedCallback(){super.connectedCallback(),this.route=location.hash,this._hashChangeListener=this._onHashChange.bind(this),window.addEventListener("hashchange",this._hashChangeListener)}_onProfilePictureLoaded(e){if(!e.detail)return;const t=e.target;if(e.detail.value){const e=Be(500,!0);t.animate(e.effect,e.options),t.classList.add("shown"),t.removeEventListener("loaded-changed",this._onProfilePictureLoaded)}}firstUpdated(){return it(this,void 0,void 0,function*(){const e=yield this._toDataURL("https://source.unsplash.com/collection/1727869/1366x768");this.container.style.backgroundImage=`url('${e}')`,this.picture.loaded?this._onProfilePictureLoaded({target:this.picture,detail:{value:!0}}):this.picture.addEventListener("loaded-changed",this._onProfilePictureLoaded)})}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("hashchange",this._hashChangeListener)}_toDataURL(e){return new Promise(t=>{const n=new Image;n.crossOrigin="Anonymous",n.onload=()=>{const e=document.createElement("canvas"),r=e.getContext("2d");e.height=n.naturalHeight,e.width=n.naturalWidth,r.drawImage(n,0,0),this.loaded=!0,t(e.toDataURL("image/jpeg"))},n.src=e})}_onHashChange(e){e.newURL?this.route=new URL(e.newURL).hash:this.route=null}static get styles(){return Ne`
        .profile {
            width: 24vw;
            padding: 4vh 3vw;
            height: 92vh;
        ...
        `}render(){return Q`
        <div role="link" id="container" class="profile ${"#!home"!==this.route&&this.route?"is-link":""}" @click=${()=>qe.Routing.navigate("home")}>
            ...
            <div class="night-switch" @click=${e=>it(this,void 0,void 0,function*(){return qe.UI.nightSwitchClick(e,this)})}>${this._nightToggle()}</div>
        </div>
        `}_nightToggle(){return"day"===qe.UI.dayOrNight()?this._day:this._night}get _day(){return Q`
        ...
        `}get picture(){return this.shadowRoot.querySelector("#pic")}get container(){return this.shadowRoot.querySelector("#container")}}ot.is="ui-profile",rt([Ce({type:String,reflect:!0})],ot.prototype,"route",void 0),rt([Ce({type:Boolean,reflect:!0})],ot.prototype,"loaded",void 0),customElements.define(ot.is,ot);class at extends Ue{get head(){return{title:"Work",description:"",type:"page",image:"",slug:"#!home"}}static get styles(){return Ne`
        h1 {
            font-family: var(--elara-font-display);
            user-select: none;
        }
        ...
        <div class="contact">
            ...
            ${this.isSuccess?Q`Thanks for your message ! I will try to reply as soon as possible 😀 `:Q``}
            ${this.inError?Q`An error occured, please retry later. 😔`:Q``}
            <div class="clearfix"></div>
            <a class="prev" @click=${()=>qe.Routing.navigate("projects")}>< Projects</a>
            <div class="grid networks">
                ${Xe(this._links,e=>this._makeLink(e.label,e.link,e.svg))}
            </div>
        </div>
        `}_makeLink(e,t,n){return Q`
            <div aria-label=${e} class="item ${e.toLowerCase()}" @click=${()=>{qe.Routing.redirect(t)}} role="link">
                ${n}
            </div>
        `}_doSend(e){return ct(this,void 0,void 0,function*(){const t={form:this.shadowRoot.querySelector("#form"),submit:e.target,name:this.shadowRoot.querySelector("#name"),email:this.shadowRoot.querySelector("#email"),message:this.shadowRoot.querySelector("#message")};try{(yield qe.Mailing.contact(t,"https://script.google.com/macros/s/AKfycbzdhNONz-1pGAlOktko4o5riYGErccxRfk8LsqTxq0ws31wKZ0/exec"))?this.isSuccess=!0:this.inError=!0}catch(e){this.inError=!0}})}}lt.is="ui-contact",st([Ce({type:Boolean,reflect:!0})],lt.prototype,"inError",void 0),st([Ce({type:Boolean,reflect:!0})],lt.prototype,"isSuccess",void 0),customElements.define(lt.is,lt);class ut extends Ue{get head(){return{title:"About",description:"",type:"page",image:"",slug:"#!about"}}static get styles(){return Ne`
        ...
        <div class="about">
            ...
            <div class="row">
                ...
                <div>
                    ...
                    <a role="link" class="cv" @click=${()=>qe.Routing.redirect("/assets/resume.pdf")}>CV</a>.</p>
                </div>
            </div>
            <a class="prev" @click=${()=>qe.Routing.navigate("home")}>< Work</a>
            <a class="next" @click=${()=>qe.Routing.navigate("projects")}>> Projects</a>
        </div>
        `}}ut.is="ui-about",customElements.define(ut.is,ut);var ht=function(e,t,n,r){return new(n||(n=Promise))(function(i,o){function a(e){try{c(r.next(e))}catch(e){o(e)}}function s(e){try{c(r.throw(e))}catch(e){o(e)}}function c(e){e.done?i(e.value):new n(function(t){t(e.value)}).then(a,s)}c((r=r.apply(e,t||[])).next())})};class dt extends Ue{get head(){return{title:"Projects",description:"",type:"page",image:"",slug:"#!projects"}}get projects(){return[{name:"Listen With Me",slug:"lwm",image:null,repository:null,status:"Work in progress",url:"https://lwm.io",tags:["YouTube","Collaborative","Listening"]},{name:"Dandy Costard",slug:"dandy",image:"/assets/projects/dandy.svg",repository:null,status:"Work in progress",url:null,tags:["E-Commerce","Elara","Custom menswear","ThreeJS"]},{name:"Ghostfly.dev",slug:"ghostfly",image:"/assets/me.svg",repository:"https://github.com/Ghostfly/ghostfly.dev/tree/master",status:"Work in progress",url:null,tags:["Elara","LitElement","Github Pages"]},{name:"Persin Conseil",slug:"persin",image:"/assets/projects/persin.jpg",status:"published",repository:"https://github.com/Ghostfly/persin-conseil",url:"https://www.persin.fr",tags:["Lit-Element","Elara","Workbox"]},{name:"Dobrunia Design",slug:"react",image:"/assets/projects/dobrunia.png",status:"published",repository:null,url:"https://www.dobruniadesign.com",tags:["React","HapiJS","Material-UI"]},{name:"Cheno",slug:"cheno",image:"/assets/projects/cheno.svg",status:"published",repository:null,url:"https://www.cheno.fr",tags:["Slim Framework","HTML5","CSS3"]},{name:"Renouveau Sociétal",slug:"rs",image:"/assets/projects/rs.png",status:"published",repository:null,url:"https://www.renouveausocietal.fr",tags:["WordPress","Handmade template"]},{name:"G-Addiction",slug:"g-addiction",image:"/assets/projects/g-addiction.png",status:"published",repository:null,url:"https://www.g-addiction.com",tags:["WordPress","chosen template"]},{name:"Who?",slug:"who",status:"...",repository:null,url:null,image:"/assets/projects/who.svg",tags:["?"]}]}_onIronImageLoaded(e){return ht(this,void 0,void 0,function*(){if(!e.detail)return;const t=e.target;if(e.detail.value){const e=Be(500,!0);t.classList.add("shown");const n=t.animate(e.effect,e.options);yield n.finished,t.removeEventListener("loaded-changed",this._onIronImageLoaded)}})}connectedCallback(){const e=Object.create(null,{connectedCallback:{get:()=>super.connectedCallback}});return ht(this,void 0,void 0,function*(){e.connectedCallback.call(this),yield this.updateComplete,this.images=this.shadowRoot.querySelectorAll("iron-image"),this.images.forEach(e=>{e.addEventListener("loaded-changed",this._onIronImageLoaded)})})}disconnectedCallback(){super.disconnectedCallback()}static get styles(){return Ne`
        h1, h2 { user-select: none; font-family: var(--elara-font-display); }
        h1::first-letter { font-size: 1.3em; }
        h2::first-letter { font-size: 1.2em }
        ...
        <section class="project">
            <div class="hidden-content grid">
                <div class="left">
                    <h3 class="${e.slug} ${e.url?"with-link":"normal"}" role="${e.url?"link":"title"}"  @click=${()=>{e.url&&qe.Routing.redirect(e.url)}}>${e.name}</h3>
                    <div class="tags">
                        ${e.tags.join(", ")}
                    </div>
                    <br />
                    <div class="status">
                        ${e.repository?Q`<svg @click=${()=>{qe.Routing.redirect(e.repository)}} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><rect x="0" fill="none" width="24" height="24"/><g><path d="M12 2C6.477 2 2 6.477 2 12c0 4.42 2.865 8.166 6.84 9.49.5.09.68-.22.68-.485 0-.236-.008-.866-.013-1.7-2.782.603-3.37-1.34-3.37-1.34-.454-1.156-1.11-1.464-1.11-1.464-.908-.62.07-.607.07-.607 1.004.07 1.532 1.03 1.532 1.03.89 1.53 2.34 1.09 2.91.833.09-.647.348-1.086.634-1.337-2.22-.252-4.555-1.112-4.555-4.944 0-1.09.39-1.984 1.03-2.682-.104-.254-.448-1.27.096-2.646 0 0 .84-.27 2.75 1.025.8-.223 1.654-.333 2.504-.337.85.004 1.705.114 2.504.336 1.91-1.294 2.748-1.025 2.748-1.025.546 1.376.202 2.394.1 2.646.64.7 1.026 1.59 1.026 2.682 0 3.84-2.337 4.687-4.565 4.935.36.307.68.917.68 1.852 0 1.335-.013 2.415-.013 2.74 0 .27.18.58.688.482C19.138 20.16 22 16.416 22 12c0-5.523-4.477-10-10-10z"/></g></svg>`:Q``}
                        ${e.status}
                    </div>
                </div>
                <div class="right">
        ...
        <div class="projects">
            <h1>${this.head.title}</h1>
            ${Xe(this.projects,this._card)}
            <a class="prev" @click=${()=>qe.Routing.navigate("about")}>< About</a>
            <a class="next" @click=${()=>qe.Routing.navigate("contact")}>> Contact</a>
        </div>
        `}}dt.is="ui-projects",customElements.define(dt.is,dt);var pt=function(e,t,n,r){var i,o=arguments.length,a=o<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,n):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(i=e[s])&&(a=(o<3?i(a):o>3?i(t,n,a):i(t,n))||a);return o>3&&a&&Object.defineProperty(t,n,a),a};class ft extends Ue{constructor(){super(...arguments),this.height=300,this.width=300}firstUpdated(){const e=this._canvas.getContext("2d");window.requestAnimationFrame(()=>{this._tree(e,600,600,80,-Math.PI/2,13,13)})}static get styles(){return Ne`
        #tree {
            position: fixed;
        }
        `}render(){return Q`<canvas id="tree" height="${this.height}" width="${this.width}"></canvas>`}_tree(e,t,n,r,i,o,a){const s=Math.random;let c,l,u,h;const d=2*Math.PI/4;e.beginPath(),e.moveTo(t,n),u=t+r*Math.cos(i),h=n+r*Math.sin(i),e.lineCap="round",e.lineWidth=a,e.lineTo(u,h),e.strokeStyle=o<=2?"#1b1b1b":"night"===qe.UI.dayOrNight()?"#f0f0f0":"#333",e.stroke();const p=o-1;if(!p)return;const f=2*s()+1;a*=.7;for(let t=0;t<f;t++)l=i+s()*d-.5*d,c=r*(.7+.3*s()),this._tree(e,u,h,c,l,p,a)}get _canvas(){return this.shadowRoot.querySelector("#tree")}}ft.is="ui-tree",pt([Ce({type:Number,reflect:!0})],ft.prototype,"height",void 0),pt([Ce({type:Number,reflect:!0})],ft.prototype,"width",void 0),customElements.define(ft.is,ft);var vt=function(e,t,n,r){var i,o=arguments.length,a=o<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,n):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(i=e[s])&&(a=(o<3?i(a):o>3?i(t,n,a):i(t,n))||a);return o>3&&a&&Object.defineProperty(t,n,a),a};class yt extends Ue{constructor(e){super(),this.asked=e}static get styles(){return Ne`
        h1, p {
            user-select: none;
            z-index: 1;
        }
        ...
        <div>
            ...
            <a @click=${()=>qe.Routing.navigate("home")}><iron-icon icon="home"></iron-icon> Homepage</a>
            <ui-tree .width=${1366} .height=${768}></ui-tree>
        </div>
        `}}yt.is="ui-not-found",vt([Ce({type:String,reflect:!0})],yt.prototype,"asked",void 0),customElements.define(yt.is,yt);var gt=function(e,t,n,r){var i,o=arguments.length,a=o<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,n):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(i=e[s])&&(a=(o<3?i(a):o>3?i(t,n,a):i(t,n))||a);return o>3&&a&&Object.defineProperty(t,n,a),a};class mt extends Ue{constructor(){super(...arguments),this.items=[],this.route=null,this.shown=!1}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback()}static get styles(){return Ne`
        .menu {
			position: absolute;
			top: 0;
			right: 0;
        ...
        <div id="menu" class="menu-content ${!0===this.shown?"shown":""}">
            <paper-icon-button class="menu" icon="close" aria-label="Close menu" @click=${()=>qe.UI.elara().menu(!0)}></paper-icon-button>
            ${Xe(this.items,e=>this._link(e))}
		</div>
        `}_link({route:e,name:t}){return Q`
		<a class="item ${this.route===e?"active":""}" @click=${()=>qe.UI.elara().show(e)}>${t}</a>
		`}}mt.is="ui-menu",gt([Ce({type:Array,reflect:!1})],mt.prototype,"items",void 0),gt([Ce({type:String,reflect:!0})],mt.prototype,"route",void 0),gt([Ce({type:Boolean,reflect:!0})],mt.prototype,"shown",void 0),customElements.define(mt.is,mt),n.d(t,"ElaraApp",function(){return _t});var wt=function(e,t,n,r){var i,o=arguments.length,a=o<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,n):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(i=e[s])&&(a=(o<3?i(a):o>3?i(t,n,a):i(t,n))||a);return o>3&&a&&Object.defineProperty(t,n,a),a},bt=function(e,t,n,r){return new(n||(n=Promise))(function(i,o){function a(e){try{c(r.next(e))}catch(e){o(e)}}function s(e){try{c(r.throw(e))}catch(e){o(e)}}function c(e){e.done?i(e.value):new n(function(t){t(e.value)}).then(a,s)}c((r=r.apply(e,t||[])).next())})};Promise.all([n.e(1),n.e(2)]).then(n.bind(null,59));class _t extends Ue{createRenderRoot(){return this.attachShadow({mode:"open"})}connectedCallback(){super.connectedCallback(),qe.UI.applyVariablesFor(qe.UI.dayOrNight()),this._onHashChangeListener=this._onHashChange.bind(this),window.addEventListener("hashchange",this._onHashChangeListener,{passive:!0})}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("hashchange",this._onHashChangeListener)}askModeChange(e){return qe.UI.applyVariablesFor(e),!0}get loadables(){return["ui-profile"]}get bootstrap(){return qe.Bootstrap.promise(this.loadables,this.shadowRoot)}show(e){return bt(this,void 0,void 0,function*(){qe.Routing.navigate(e),yield this._hideMenu()})}menu(e){return bt(this,void 0,void 0,function*(){return e?this._hideMenu():this._showMenu()})}load(e){return bt(this,void 0,void 0,function*(){const t="%s | Léonard C.",n=customElements.get("ui-"+e);this.route=e,this._content.classList.remove("full-width");const r=customElements.get("ui-not-found"),i=n?new n:new r(e);if(i.head&&i.head.title?document.title=t.replace("%s",i.head.title):document.title="Léonard C.",!0!==i.isFullWidth||this._content.classList.contains("full-width")?i.isFullWidth||this._content.classList.remove("full-width"):this._content.classList.add("full-width"),this._content.appendChild(i),i instanceof r)throw new qe.Errors.NotFound(e);window.scrollTo(0,0),this._menu.classList.contains("shown")&&null===this._menuFade&&(yield this._hideMenu());const o=window.requestAnimationFrame(()=>{if(!i.shadowRoot)return void cancelAnimationFrame(o);const e=i.shadowRoot.querySelector("div");if(!e)return void cancelAnimationFrame(o);const t=He(300);e.animate(t.effect,t.options)})})}firstUpdated(){const e=new HashChangeEvent("hashchange",{newURL:location.hash,oldURL:null});this._onHashChange(e)}static get styles(){return Ne`
		...
		`}_showMenu(){return bt(this,void 0,void 0,function*(){if(this._menu.classList.contains("shown"))return void(yield this._hideMenu());if(this._menuFade)return;this._content.classList.contains("hidden")||this._content.classList.add("hidden"),!1===this._menu.shown&&(this._menu.shown=!0);const e=Be(300,!0);this._menuFade=this._menu.animate(e.effect,e.options),yield this._menuFade.finished,this._menuFade=null})}_hideMenu(){return bt(this,void 0,void 0,function*(){if(this._menuFade)return;const e=Be(300,!1);this._menuFade=this._menu.animate(e.effect,e.options),yield this._menuFade.finished,this._content.classList.remove("hidden"),this._menu.shown=!1,this._menuFade=null})}_onHashChange(e){return bt(this,void 0,void 0,function*(){const t=qe.Routing.hashChange(e,this.route);this._content.innerHTML="",yield this.load(t)})}get _content(){return this.shadowRoot.querySelector("#content")}get _menu(){return this.shadowRoot.querySelector("#menu")}}_t.is="elara-app",wt([Ce({reflect:!0,type:String})],_t.prototype,"route",void 0),customElements.define(_t.is,_t)}]);
//# sourceMappingURL=main.1d549364.js.map