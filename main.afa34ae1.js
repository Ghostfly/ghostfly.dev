 ...
 */class rt extends Ve{constructor(){super(...arguments),this.repositories=[],this.currentPage=null,this.page=0,this.inError=!1,this.chunksLength=6}firstUpdated(){return nt(this,void 0,void 0,function*(){this._spinner.active=!0;const e=new XMLHttpRequest;e.open("POST","https://api.github.com/graphql",!0),e.setRequestHeader("Authorization","bearer "+atob("ZDQ0Y2JmYjVlOGRiOTRjMjJkNThlYjg4ZjFlNjIyODM4YzQ1N2Q3Mg==")),e.send(JSON.stringify({query:'{ search(query: "user:ghostfly is:public", type: REPOSITORY, first: 100) { repositoryCount edges { node { ... on Repository { name stargazers { totalCount } description forkCount createdAt url primaryLanguage {name} }}}}}'}));const t=()=>{if(!this._spinner)return;this._spinner.active=!1;const e=this._spinner.parentElement;e.removeChild(this._spinner),this.shadowRoot.removeChild(e)},n=()=>{t(),this.inError=!0};e.onerror=n,e.onreadystatechange=()=>nt(this,void 0,void 0,function*(){if(4==e.readyState&&200==e.status){const n=JSON.parse(e.responseText).data.search.edges.sort((e,t)=>new Date(t.node.createdAt)-new Date(e.node.createdAt));this.repositories=this._chunk(n,this.chunksLength),this.currentPage=this.repositories[this.page],t(),yield this.updateComplete,this._pulse()}403===e.status&&n()})})}_chunk(e,t){const n=[],r=e.length;let i=0;for(;i<r;)n.push(e.slice(i,i+=t));return n}static get styles(){return Le`
        ...
        `}_card(e){return Q`
        <section class="github-card" @click=${()=>We.Routing.redirect(e.node.url)}}>
        ...
        ${this.currentPage?Q`
        <div class="two-cols">
            ${et(this.currentPage,this._card)}
        </div>
        ${this._pagination}
        `:Q``}
        <a class="next" @click=${()=>We.Routing.navigate("about")}>> About</a>
        ...
        <a role="button" disabled=${0===this.page} @click=${()=>nt(this,void 0,void 0,function*(){this.page--,this.currentPage=this.repositories[this.page],yield this.updateComplete,this._pulse()})}>
            <paper-icon-button aria-label="Previous page" icon="arrow-back"></paper-icon-button>
        </a>
        `}get _next(){return Q`
        <a role="button" disabled=${this.page+1===this.repositories.length} @click=${()=>nt(this,void 0,void 0,function*(){this.page++,this.currentPage=this.repositories[this.page],yield this.updateComplete,this._pulse()})}>
            <paper-icon-button aria-label="Next page" icon="arrow-forward"></paper-icon-button>
        </a>
        `}get _spinner(){return this.shadowRoot.querySelector("paper-spinner")}}rt.is="ui-github-work",tt([Ce({type:Array})],rt.prototype,"repositories",void 0),tt([Ce({type:Array})],rt.prototype,"currentPage",void 0),tt([Ce({type:Number,reflect:!0})],rt.prototype,"page",void 0),tt([Ce({type:Boolean,reflect:!0})],rt.prototype,"inError",void 0),customElements.define(rt.is,rt);var it=function(e,t,n,r){var i,o=arguments.length,a=o<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,n):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(i=e[s])&&(a=(o<3?i(a):o>3?i(t,n,a):i(t,n))||a);return o>3&&a&&Object.defineProperty(t,n,a),a},ot=function(e,t,n,r){return new(n||(n=Promise))(function(i,o){function a(e){try{c(r.next(e))}catch(e){o(e)}}function s(e){try{c(r.throw(e))}catch(e){o(e)}}function c(e){e.done?i(e.value):new n(function(t){t(e.value)}).then(a,s)}c((r=r.apply(e,t||[])).next())})};class at extends Ve{constructor(){super(...arguments),this.loaded=!1}connectedCallback(){super.connectedCallback(),this.route=location.hash,this._hashChangeListener=this._onHashChange.bind(this),window.addEventListener("hashchange",this._hashChangeListener)}_onProfilePictureLoaded(e){if(!e.detail)return;const t=e.target;if(e.detail.value){const e=qe(500,!0);t.animate(e.effect,e.options),t.classList.add("shown"),t.removeEventListener("loaded-changed",this._onProfilePictureLoaded)}}firstUpdated(){return ot(this,void 0,void 0,function*(){const e=yield We.UI.processing.toDataURL("https://source.unsplash.com/collection/1727869/1366x768");this.loaded=!0,this.container.style.backgroundImage=`url('${e}')`,this.picture.loaded?this._onProfilePictureLoaded({target:this.picture,detail:{value:!0}}):this.picture.addEventListener("loaded-changed",this._onProfilePictureLoaded)})}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("hashchange",this._hashChangeListener)}_onHashChange(e){e.newURL?this.route=new URL(e.newURL).hash:this.route=null}static get styles(){return Le`
        .profile {
            width: 24vw;
            padding: 4vh 3vw;
            height: 92vh;
        ...
        `}render(){return Q`
        <div role="link" id="container" class="profile ${"#!home"!==this.route&&this.route?"is-link":""}" @click=${()=>We.Routing.navigate("home")}>
            ...
            <div class="night-switch" @click=${e=>ot(this,void 0,void 0,function*(){return We.UI.nightSwitchClick(e,this)})}>${this._nightToggle()}</div>
        </div>
        `}_nightToggle(){return"day"===We.UI.dayOrNight()?this._day:this._night}get _day(){return Q`
        ...
        `}get picture(){return this.shadowRoot.querySelector("#pic")}get container(){return this.shadowRoot.querySelector("#container")}}at.is="ui-profile",it([Ce({type:String,reflect:!0})],at.prototype,"route",void 0),it([Ce({type:Boolean,reflect:!0})],at.prototype,"loaded",void 0),customElements.define(at.is,at);class st extends Ve{get head(){return{title:"Work",description:"",type:"page",image:"",slug:"#!home"}}static get styles(){return Le`
        h1 {
            font-family: var(--elara-font-display);
            user-select: none;
        }
        ...
        .github svg { ${Ne(`fill: ${We.Colors.social.github}`)}}
        .twitter svg { ${Ne(`fill: ${We.Colors.social.twitter}`)}}
        .youtube svg { ${Ne(`fill: ${We.Colors.social.youtube}`)}}
        .linkedin svg { ${Ne(`fill: ${We.Colors.social.linkedin}`)}}
        .facebook svg { ${Ne(`fill: ${We.Colors.social.facebook}`)}}
        .instagram svg { ${Ne(`fill: ${We.Colors.social.instagram}`)}}
        .medium svg { ${Ne(`fill: ${We.Colors.social.medium}`)}}
        ...
        <div class="contact">
            ...
            ${this.isSuccess?Q`${We.Mailing.success}`:Q``}
            ${this.inError?Q`${We.Mailing.error}`:Q``}
            <div class="clearfix"></div>
            <a class="prev" @click=${()=>We.Routing.navigate("projects")}>< Projects</a>
            <div class="grid networks">
                ${et(this._links,e=>this._makeLink(e.label,e.link,e.svg))}
            </div>
        </div>
        `}_makeLink(e,t,n){return Q`
            <div aria-label=${e} class="item ${e.toLowerCase()}" @click=${()=>{We.Routing.redirect(t)}} role="link">
                ${n}
            </div>
        `}_doSend(e){return lt(this,void 0,void 0,function*(){const t={form:this.shadowRoot.querySelector("#form"),submit:e.target,name:this.shadowRoot.querySelector("#name"),email:this.shadowRoot.querySelector("#email"),message:this.shadowRoot.querySelector("#message")};try{(yield We.Mailing.contact(t,"https://script.google.com/macros/s/AKfycbzdhNONz-1pGAlOktko4o5riYGErccxRfk8LsqTxq0ws31wKZ0/exec"))?(this.inError=!1,this.isSuccess=!0):(this.isSuccess=!1,this.inError=!1)}catch(e){this.inError=!0}})}}ut.is="ui-contact",ct([Ce({type:Boolean,reflect:!0})],ut.prototype,"inError",void 0),ct([Ce({type:Boolean,reflect:!0})],ut.prototype,"isSuccess",void 0),customElements.define(ut.is,ut);class ht extends Ve{get head(){return{title:"About",description:"",type:"page",image:"",slug:"#!about"}}static get styles(){return Le`
        ...
        <div class="about">
            ...
            <div class="row">
                ...
                <div>
                    ...
                    <a role="link" class="cv" @click=${()=>We.Routing.redirect("/assets/resume.pdf")}>CV</a>.</p>
                </div>
            </div>
            <a class="prev" @click=${()=>We.Routing.navigate("home")}>< Work</a>
            <a class="next" @click=${()=>We.Routing.navigate("projects")}>> Projects</a>
        </div>
        `}}ht.is="ui-about",customElements.define(ht.is,ht);var dt=function(e,t,n,r){return new(n||(n=Promise))(function(i,o){function a(e){try{c(r.next(e))}catch(e){o(e)}}function s(e){try{c(r.throw(e))}catch(e){o(e)}}function c(e){e.done?i(e.value):new n(function(t){t(e.value)}).then(a,s)}c((r=r.apply(e,t||[])).next())})};class pt extends Ve{get head(){return{title:"Projects",description:"",type:"page",image:"",slug:"#!projects"}}get projects(){return[{name:"Listen With Me",slug:"lwm",image:null,repository:null,status:"Work in progress",url:"https://lwm.io",tags:["YouTube","Collaborative","Listening"]},{name:"Dandy Costard",slug:"dandy",image:"/assets/projects/dandy.svg",repository:null,status:"Work in progress",url:null,tags:["E-Commerce","Elara","Custom menswear","ThreeJS"]},{name:"Ghostfly.dev",slug:"ghostfly",image:"/assets/me.svg",repository:"https://github.com/Ghostfly/ghostfly.dev/tree/master",status:"Work in progress",url:null,tags:["Elara","LitElement","Github Pages"]},{name:"Persin Conseil",slug:"persin",image:"/assets/projects/persin.jpg",status:"published",repository:"https://github.com/Ghostfly/persin-conseil",url:"https://www.persin.fr",tags:["Lit-Element","Elara","Workbox"]},{name:"Dobrunia Design",slug:"react",image:"/assets/projects/dobrunia.png",status:"published",repository:null,url:"https://www.dobruniadesign.com",tags:["React","HapiJS","Material-UI"]},{name:"Cheno",slug:"cheno",image:"/assets/projects/cheno.svg",status:"published",repository:null,url:"https://www.cheno.fr",tags:["Slim Framework","HTML5","CSS3"]},{name:"Renouveau Sociétal",slug:"rs",image:"/assets/projects/rs.png",status:"published",repository:null,url:"https://www.renouveausocietal.fr",tags:["WordPress","Handmade template"]},{name:"G-Addiction",slug:"g-addiction",image:"/assets/projects/g-addiction.png",status:"published",repository:null,url:"https://www.g-addiction.com",tags:["WordPress","chosen template"]},{name:"Who?",slug:"who",status:"...",repository:null,url:null,image:"/assets/projects/who.svg",tags:["?"]}]}_onIronImageLoaded(e){return dt(this,void 0,void 0,function*(){if(!e.detail)return;const t=e.target;if(e.detail.value){const e=qe(500,!0);t.classList.add("shown");const n=t.animate(e.effect,e.options);yield n.finished,t.removeEventListener("loaded-changed",this._onIronImageLoaded)}})}connectedCallback(){const e=Object.create(null,{connectedCallback:{get:()=>super.connectedCallback}});return dt(this,void 0,void 0,function*(){e.connectedCallback.call(this),yield this.updateComplete,this.images=this.shadowRoot.querySelectorAll("iron-image"),this.images.forEach(e=>{e.addEventListener("loaded-changed",this._onIronImageLoaded)})})}disconnectedCallback(){super.disconnectedCallback()}static get styles(){return Le`
        h1, h2 { user-select: none; font-family: var(--elara-font-display); }
        h1::first-letter { font-size: 1.3em; }
        h2::first-letter { font-size: 1.2em }
        ...
        <section class="project">
            <div class="hidden-content grid">
                <div class="left">
                    <h3 class="${e.slug} ${e.url?"with-link":"normal"}" role="${e.url?"link":"title"}"  @click=${()=>{e.url&&We.Routing.redirect(e.url)}}>${e.name}</h3>
                    <div class="tags">
                        ${e.tags.join(", ")}
                    </div>
                    <br />
                    <div class="status">
                        ${e.repository?Q`<svg @click=${()=>{We.Routing.redirect(e.repository)}} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><rect x="0" fill="none" width="24" height="24"/><g><path d="M12 2C6.477 2 2 6.477 2 12c0 4.42 2.865 8.166 6.84 9.49.5.09.68-.22.68-.485 0-.236-.008-.866-.013-1.7-2.782.603-3.37-1.34-3.37-1.34-.454-1.156-1.11-1.464-1.11-1.464-.908-.62.07-.607.07-.607 1.004.07 1.532 1.03 1.532 1.03.89 1.53 2.34 1.09 2.91.833.09-.647.348-1.086.634-1.337-2.22-.252-4.555-1.112-4.555-4.944 0-1.09.39-1.984 1.03-2.682-.104-.254-.448-1.27.096-2.646 0 0 .84-.27 2.75 1.025.8-.223 1.654-.333 2.504-.337.85.004 1.705.114 2.504.336 1.91-1.294 2.748-1.025 2.748-1.025.546 1.376.202 2.394.1 2.646.64.7 1.026 1.59 1.026 2.682 0 3.84-2.337 4.687-4.565 4.935.36.307.68.917.68 1.852 0 1.335-.013 2.415-.013 2.74 0 .27.18.58.688.482C19.138 20.16 22 16.416 22 12c0-5.523-4.477-10-10-10z"/></g></svg>`:Q``}
                        ${e.status}
                    </div>
                </div>
                <div class="right">
        ...
        <div class="projects">
            <h1>${this.head.title}</h1>
            ${et(this.projects,this._card)}
            <a class="prev" @click=${()=>We.Routing.navigate("about")}>< About</a>
            <a class="next" @click=${()=>We.Routing.navigate("contact")}>> Contact</a>
        </div>
        `}}pt.is="ui-projects",customElements.define(pt.is,pt);var ft=function(e,t,n,r){var i,o=arguments.length,a=o<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,n):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(i=e[s])&&(a=(o<3?i(a):o>3?i(t,n,a):i(t,n))||a);return o>3&&a&&Object.defineProperty(t,n,a),a};class vt extends Ve{constructor(){super(...arguments),this.height=300,this.width=300}firstUpdated(){const e=this._canvas.getContext("2d");window.requestAnimationFrame(()=>{this._tree(e,600,600,80,-Math.PI/2,13,13)})}static get styles(){return Le`
        #tree {
            position: fixed;
        }
        `}render(){return Q`<canvas id="tree" height="${this.height}" width="${this.width}"></canvas>`}_tree(e,t,n,r,i,o,a){const s=Math.random;let c,l,u,h;const d=2*Math.PI/4;e.beginPath(),e.moveTo(t,n),u=t+r*Math.cos(i),h=n+r*Math.sin(i),e.lineCap="round",e.lineWidth=a,e.lineTo(u,h),e.strokeStyle=o<=2?"#1b1b1b":"night"===We.UI.dayOrNight()?"#f0f0f0":"#333",e.stroke();const p=o-1;if(!p)return;const f=2*s()+1;a*=.7;for(let t=0;t<f;t++)l=i+s()*d-.5*d,c=r*(.7+.3*s()),this._tree(e,u,h,c,l,p,a)}get _canvas(){return this.shadowRoot.querySelector("#tree")}}vt.is="ui-tree",ft([Ce({type:Number,reflect:!0})],vt.prototype,"height",void 0),ft([Ce({type:Number,reflect:!0})],vt.prototype,"width",void 0),customElements.define(vt.is,vt);var gt=function(e,t,n,r){var i,o=arguments.length,a=o<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,n):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(i=e[s])&&(a=(o<3?i(a):o>3?i(t,n,a):i(t,n))||a);return o>3&&a&&Object.defineProperty(t,n,a),a};class yt extends Ve{constructor(e){super(),this.asked=e}static get styles(){return Le`
        h1, p {
            user-select: none;
            z-index: 1;
        }
        ...
        <div>
            ...
            <a @click=${()=>We.Routing.navigate("home")}><iron-icon icon="home"></iron-icon> Homepage</a>
            <ui-tree .width=${1366} .height=${768}></ui-tree>
        </div>
        `}}yt.is="ui-not-found",gt([Ce({type:String,reflect:!0})],yt.prototype,"asked",void 0),customElements.define(yt.is,yt);var mt=function(e,t,n,r){var i,o=arguments.length,a=o<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,n):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(i=e[s])&&(a=(o<3?i(a):o>3?i(t,n,a):i(t,n))||a);return o>3&&a&&Object.defineProperty(t,n,a),a};class wt extends Ve{constructor(){super(...arguments),this.items=[],this.route=null,this.shown=!1}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback()}static get styles(){return Le`
        .menu {
			position: absolute;
			top: 0;
			right: 0;
        ...
        <div id="menu" class="menu-content ${!0===this.shown?"shown":""}">
            <paper-icon-button class="menu" icon="close" aria-label="Close menu" @click=${()=>We.UI.elara().menu(!0)}></paper-icon-button>
            ${et(this.items,e=>this._link(e))}
		</div>
        `}_link({route:e,name:t}){return Q`
		<a class="item ${this.route===e?"active":""}" @click=${()=>We.UI.elara().show(e)}>${t}</a>
		`}}wt.is="ui-menu",mt([Ce({type:Array,reflect:!1})],wt.prototype,"items",void 0),mt([Ce({type:String,reflect:!0})],wt.prototype,"route",void 0),mt([Ce({type:Boolean,reflect:!0})],wt.prototype,"shown",void 0),customElements.define(wt.is,wt),n.d(t,"ElaraApp",function(){return xt});var bt=function(e,t,n,r){var i,o=arguments.length,a=o<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,n):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(i=e[s])&&(a=(o<3?i(a):o>3?i(t,n,a):i(t,n))||a);return o>3&&a&&Object.defineProperty(t,n,a),a},_t=function(e,t,n,r){return new(n||(n=Promise))(function(i,o){function a(e){try{c(r.next(e))}catch(e){o(e)}}function s(e){try{c(r.throw(e))}catch(e){o(e)}}function c(e){e.done?i(e.value):new n(function(t){t(e.value)}).then(a,s)}c((r=r.apply(e,t||[])).next())})};Promise.all([n.e(1),n.e(2)]).then(n.bind(null,59));class xt extends Ve{createRenderRoot(){return this.attachShadow({mode:"open"})}connectedCallback(){super.connectedCallback(),We.UI.applyVariablesFor(We.UI.dayOrNight()),this._onHashChangeListener=this._onHashChange.bind(this),window.addEventListener("hashchange",this._onHashChangeListener,{passive:!0})}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("hashchange",this._onHashChangeListener)}askModeChange(e){return We.UI.applyVariablesFor(e),!0}get loadables(){return["ui-profile"]}get bootstrap(){return We.Bootstrap.promise(this.loadables,this.shadowRoot)}show(e){return _t(this,void 0,void 0,function*(){We.Routing.navigate(e),yield this._hideMenu()})}menu(e){return _t(this,void 0,void 0,function*(){return e?this._hideMenu():this._showMenu()})}load(e){return _t(this,void 0,void 0,function*(){return We.Bootstrap.load(e,this._content,this._menu,this._menuFade)})}firstUpdated(){const e=new HashChangeEvent("hashchange",{newURL:location.hash,oldURL:null});this._onHashChange(e)}static get styles(){return Le`
