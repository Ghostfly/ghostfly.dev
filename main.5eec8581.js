 ...
 * http://polymer.github.io/PATENTS.txt
 */
var W=new(function(){function e(){!function(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}(this,e)}var t,n,r;return t=e,(n=[{key:"handleAttributeExpressions",value:function(e,t,n,r){var i=t[0];return"."===i?new V(e,t.slice(1),n).parts:"@"===i?[new F(e,t.slice(1),r.eventContext)]:"?"===i?[new z(e,t.slice(1),n)]:new T(e,t,n).parts}},{key:"handleTextExpression",value:function(e){return new M(e)}}])&&B(t.prototype,n),r&&B(t,r),e}());
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 */var Be={type:"oauth",key:"437be1c1aa051344aa05",secret:"b8e34932aba7ce334d4c3cd9d1f1f406d64756cb"},We=function(e,t,n,r){var i,o=arguments.length,a=o<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,n):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(i=e[s])&&(a=(o<3?i(a):o>3?i(t,n,a):i(t,n))||a);return o>3&&a&&Object.defineProperty(t,n,a),a},De=function(e,t,n,r){return new(n||(n=Promise))(function(i,o){function a(e){try{c(r.next(e))}catch(e){o(e)}}function s(e){try{c(r.throw(e))}catch(e){o(e)}}function c(e){e.done?i(e.value):new n(function(t){t(e.value)}).then(a,s)}c((r=r.apply(e,t||[])).next())})};class Ge extends Ae{constructor(){super(...arguments),this.repositories=[],this.currentPage=null,this.page=0,this.inError=!1,this.chunksLength=6}firstUpdated(){return De(this,void 0,void 0,function*(){this._spinner.active=!0;const e=new XMLHttpRequest;e.open("GET","https://cors-anywhere.herokuapp.com/https://api.github.com/users/ghostfly/repos",!0),e.setRequestHeader("type",Be.type),e.setRequestHeader("key",Be.key),e.setRequestHeader("secret",Be.secret),e.send();const t=()=>{if(!this._spinner)return;this._spinner.active=!1;const e=this._spinner.parentElement;e.removeChild(this._spinner),this.shadowRoot.removeChild(e)},n=()=>{t(),this.inError=!0};e.onerror=n,e.onreadystatechange=(()=>De(this,void 0,void 0,function*(){if(4==e.readyState&&200==e.status){const n=JSON.parse(e.responseText).filter(e=>!e.fork).sort((e,t)=>new Date(t.created_at)-new Date(e.created_at));this.repositories=this._chunk(n,this.chunksLength),this.currentPage=this.repositories[this.page],t(),yield this.updateComplete,this._pulse()}403===e.status&&n()}))})}_chunk(e,t){const n=[],r=e.length;let i=0;for(;i<r;)n.push(e.slice(i,i+=t));return n}render(){return Y`
        ...
        `}get _spinner(){return this.shadowRoot.querySelector("paper-spinner")}}Ge.is="ui-github-work",We([Se({type:Array})],Ge.prototype,"repositories",void 0),We([Se({type:Array})],Ge.prototype,"currentPage",void 0),We([Se({type:Number,reflect:!0})],Ge.prototype,"page",void 0),We([Se({type:Boolean,reflect:!0})],Ge.prototype,"inError",void 0),customElements.define(Ge.is,Ge);var Je=function(e,t,n,r){var i,o=arguments.length,a=o<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,n):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(i=e[s])&&(a=(o<3?i(a):o>3?i(t,n,a):i(t,n))||a);return o>3&&a&&Object.defineProperty(t,n,a),a},Ye=function(e,t,n,r){return new(n||(n=Promise))(function(i,o){function a(e){try{c(r.next(e))}catch(e){o(e)}}function s(e){try{c(r.throw(e))}catch(e){o(e)}}function c(e){e.done?i(e.value):new n(function(t){t(e.value)}).then(a,s)}c((r=r.apply(e,t||[])).next())})};class Ke extends Ae{connectedCallback(){super.connectedCallback(),this.route=location.hash,this._hashChangeListener=this._onHashChange.bind(this),window.addEventListener("hashchange",this._hashChangeListener)}firstUpdated(){return Ye(this,void 0,void 0,function*(){const e=yield this._toDataURL("https://source.unsplash.com/collection/1727869/1366x768");this.container.style.backgroundImage=`url('${e}')`})}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("hashchange",this._hashChangeListener)}_toDataURL(e){return new Promise(t=>{const n=new Image;n.crossOrigin="Anonymous",n.onload=(()=>{const e=document.createElement("canvas"),r=e.getContext("2d");e.height=n.naturalHeight,e.width=n.naturalWidth,r.drawImage(n,0,0),t(e.toDataURL("image/jpeg"))}),n.src=e})}_onHashChange(e){e.newURL?this.route=new URL(e.newURL).hash:this.route=null}render(){return Y`
        <style>
        .profile {
            width: 24vw;
            padding: 4vh 3vw;
        ...
        `}get container(){return this.shadowRoot.querySelector("#container")}}Ke.is="ui-profile",Je([Se({type:String,reflect:!0})],Ke.prototype,"route",void 0),customElements.define(Ke.is,Ke);class Xe extends Ae{get head(){return{title:"Work",description:"",type:"page",image:"",slug:"#!home"}}render(){return Y`
        <style>
        h1 {
            font-family: var(--elara-font-display);
            user-select: none;
        ...
        <div class="contact">
            ...
            <div class="grid networks">
                ${Ie(this._links,e=>this._makeLink(e.label,e.link,e.svg))}
            </div>
        </div>
        ...
        `}_doSend(e){const t=this.shadowRoot.querySelector("#form"),n=e.target,r=this.shadowRoot.querySelector("#name"),i=this.shadowRoot.querySelector("#email"),o=this.shadowRoot.querySelector("#message");let a=!0;const s=[r,i,o];if(s.forEach(e=>(e=>e.validate())(e)?e.invalid=!1:e.invalid=!0),s.forEach(e=>{e.invalid&&a&&(a=!1)}),a){n.disabled=!0,s.forEach(e=>e.disabled=!0);const e=new FormData;e.append("name",r.value),e.append("email",i.value),e.append("message",o.value);const a=new XMLHttpRequest;a.open("POST","https://script.google.com/macros/s/AKfycbzdhNONz-1pGAlOktko4o5riYGErccxRfk8LsqTxq0ws31wKZ0/exec"),a.onreadystatechange=(()=>{200===a.status&&(this.isSuccess=!0,t.classList.add("sended"))}),a.onerror=(()=>{this.inError=!0}),a.send(e)}}}Qe.is="ui-contact",Ze([Se({type:Boolean,reflect:!0})],Qe.prototype,"inError",void 0),Ze([Se({type:Boolean,reflect:!0})],Qe.prototype,"isSuccess",void 0),customElements.define(Qe.is,Qe);class et extends Ae{get head(){return{title:"About",description:"",type:"page",image:"",slug:"#!about"}}render(){return Y`
        <style>
        ...
        `}}tt.is="ui-projects",customElements.define(tt.is,tt);var nt=function(e,t,n,r){var i,o=arguments.length,a=o<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,n):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(i=e[s])&&(a=(o<3?i(a):o>3?i(t,n,a):i(t,n))||a);return o>3&&a&&Object.defineProperty(t,n,a),a};class rt extends Ae{constructor(){super(...arguments),this.height=300,this.width=300}firstUpdated(){const e=this._canvas.getContext("2d");window.requestAnimationFrame(()=>{this._tree(e,600,600,80,-Math.PI/2,13,13)})}render(){return Y`<canvas id="tree" style="position: fixed;" height="${this.height}" width="${this.width}"></canvas>`}_tree(e,t,n,r,i,o,a){const s=Math.random;let c,l,u,h;const p=2*Math.PI/4;e.beginPath(),e.moveTo(t,n),u=t+r*Math.cos(i),h=n+r*Math.sin(i),e.lineCap="round",e.lineWidth=a,e.lineTo(u,h),e.strokeStyle=o<=2?"#1095a9":"#333",e.stroke();const d=o-1;if(!d)return;const f=2*s()+1;a*=.7;for(let t=0;t<f;t++)l=i+s()*p-.5*p,c=r*(.7+.3*s()),this._tree(e,u,h,c,l,d,a)}get _canvas(){return this.shadowRoot.querySelector("#tree")}}rt.is="ui-tree",nt([Se({type:Number,reflect:!0})],rt.prototype,"height",void 0),nt([Se({type:Number,reflect:!0})],rt.prototype,"width",void 0),customElements.define(rt.is,rt);var it=function(e,t,n,r){var i,o=arguments.length,a=o<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,n):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(i=e[s])&&(a=(o<3?i(a):o>3?i(t,n,a):i(t,n))||a);return o>3&&a&&Object.defineProperty(t,n,a),a};class ot extends Ae{constructor(e){super(),this.asked=e}render(){return Y`
		<style>
            h1, p {
                user-select: none;
                z-index: 1;
        ...
        `}}ot.is="ui-not-found",it([Se({type:String,reflect:!0})],ot.prototype,"asked",void 0),customElements.define(ot.is,ot);var at=function(e,t,n,r){var i,o=arguments.length,a=o<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,n):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(i=e[s])&&(a=(o<3?i(a):o>3?i(t,n,a):i(t,n))||a);return o>3&&a&&Object.defineProperty(t,n,a),a},st=function(e,t,n,r){return new(n||(n=Promise))(function(i,o){function a(e){try{c(r.next(e))}catch(e){o(e)}}function s(e){try{c(r.throw(e))}catch(e){o(e)}}function c(e){e.done?i(e.value):new n(function(t){t(e.value)}).then(a,s)}c((r=r.apply(e,t||[])).next())})};Promise.all([n.e(1),n.e(2)]).then(n.bind(null,59));class ct extends Ae{createRenderRoot(){return this.attachShadow({mode:"open"})}connectedCallback(){super.connectedCallback(),this._onHashChangeListener=this._onHashChange.bind(this),window.addEventListener("hashchange",this._onHashChangeListener,{passive:!0})}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("hashchange",this._onHashChangeListener)}_onHashChange(e){const t=e.newURL.replace(location.origin+"/","").split("/")[0];let n=null;if(t){const e=new URL(location.origin+"/"+t).hash.replace("#!","");n=e||"home"}else n="home";this.route!==n&&(this.content.innerHTML="",this.load(n))}load(e){const t="%s | Léonard C.",n=customElements.get("ui-"+e);this.route=e,this.content.classList.remove("full-width");const r=customElements.get("ui-not-found"),i=n?new n:new r(e);if(i.head&&i.head.title?document.title=t.replace("%s",i.head.title):document.title="Léonard C.",!0!==i.isFullWidth||this.content.classList.contains("full-width")?i.isFullWidth||this.content.classList.remove("full-width"):this.content.classList.add("full-width"),this.content.appendChild(i),i instanceof r)throw new $e.Errors.NotFound(e);window.scrollTo(0,0),this._hideMenu();const o=window.requestAnimationFrame(()=>{if(!i.shadowRoot)return void cancelAnimationFrame(o);const e=i.shadowRoot.querySelector("div");e?e.animate({opacity:[.5,1],transform:["scale(.95)","scale(1)"]},{duration:600}):cancelAnimationFrame(o)})}firstUpdated(){const e=new HashChangeEvent("hashchange",{newURL:location.hash,oldURL:null});this._onHashChange(e)}render(){return Y`
			<style>				
		...
		`}_showLink(e){this._hideMenu(),location.hash="#!"+e}_showMenu(){return st(this,void 0,void 0,function*(){this.content.classList.contains("hidden")||this.content.classList.add("hidden"),this.menu.classList.contains("hidden")||this.menu.classList.add("shown"),this.menu.animate({opacity:[0,1]},{duration:500})})}_hideMenu(){return st(this,void 0,void 0,function*(){const e=this.menu.animate({opacity:[1,0]},{duration:300});yield e.finished,this.content.classList.remove("hidden"),this.menu.classList.remove("shown")})}get content(){return this.shadowRoot.querySelector("#content")}get menu(){return this.shadowRoot.querySelector("#menu")}}ct.is="elara-app",at([Se({reflect:!0,type:String})],ct.prototype,"route",void 0),customElements.define(ct.is,ct)}]);
//# sourceMappingURL=main.5eec8581.js.map