	...
	public render(): void | TemplateResult {
        ...
        <div class="contact">
            ...
            <div class="grid networks">
                ...
                <div class="item medium" @click=${() => {
                    window.open('https://medium.com/@ghostfly1', '_blank');
                }} role="link">>
                ...
                <div class="item facebook" @click=${() => {
                    window.open('https://www.facebook.com/gh0std3v', '_blank');
                }} role="link">
                ...
                <div class="item instagram" @click=${() => {
                    window.open('https://www.instagram.com/gh0stfly_', '_blank');
                }} role="link">
                ...
                <div class="item phone" @click=${() => {
                    window.open('tel:+33668717002');
                }} role="link">
